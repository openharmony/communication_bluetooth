 ...
 */
#ifndef LOG_TAG
#define LOG_TAG "bt_ipc_avrcp_ct_observer_proxy"
#endif
...
void BluetoothAvrcpCtObserverProxy::OnConnectionStateChanged(const RawAddress &rawAddr, int state, int cause)
{
    ...
    if (!data.WriteInt32(cause)) {
        HILOGE("[GetDeviceState] fail: write cause failed");
        return;
    }
    MessageParcel reply;
...
void BluetoothAvrcpCtObserverProxy::OnPressButton(const RawAddress &rawAddr, uint8_t button, int result)
{
    ...
    MessageOption option = {MessageOption::TF_ASYNC};
    int error = InnerTransact(
        BluetoothAvrcpCtObserverInterfaceCode::AVRCP_CT_PRESS_BUTTON, option, data, reply);
    if (error != NO_ERROR) {
        HILOGE("error: %{public}d", error);
        return;
    }
...
void BluetoothAvrcpCtObserverProxy::OnReleaseButton(const RawAddress &rawAddr, uint8_t button,  int result)
{
    ...
    MessageOption option = {MessageOption::TF_ASYNC};
    int error = InnerTransact(
        BluetoothAvrcpCtObserverInterfaceCode::AVRCP_CT_RELEASE_BUTTON, option, data, reply);
    if (error != NO_ERROR) {
        HILOGE("error: %{public}d", error);
        return;
    }
    ...
    uint32_t numberOfItems, const std::vector<std::string> &folderNames, int result, int detail)
{
    ...
    MessageOption option = {MessageOption::TF_ASYNC};
    int error = InnerTransact(
        BluetoothAvrcpCtObserverInterfaceCode::AVRCP_CT_SET_BROWSED_PLAYER, option, data, reply);
    if (error != NO_ERROR) {
        HILOGE("error: %{public}d", error);
        return;
    }
    ...
    const std::vector<uint8_t> &events, int result)
{
    ...
    MessageOption option = {MessageOption::TF_ASYNC};
    int error = InnerTransact(
        BluetoothAvrcpCtObserverInterfaceCode::AVRCP_CT_GET_CAPABILITIES, option, data, reply);
    if (error != NO_ERROR) {
        HILOGE("error: %{public}d", error);
        return;
    }
    ...
    const RawAddress &rawAddr, std::vector<uint8_t> attributes, int result)
{
    ...
    MessageOption option = {MessageOption::TF_ASYNC};
    int error = InnerTransact(
        BluetoothAvrcpCtObserverInterfaceCode::AVRCP_CT_GET_PLAYER_APP_SETTING_ATTRIBUTES, option, data, reply);
    if (error != NO_ERROR) {
        HILOGE("error: %{public}d", error);
        return;
    }
    ...
    int attribute, const std::vector<uint8_t> &values, int result)
{
    ...
    MessageOption option = {MessageOption::TF_ASYNC};
    int error = InnerTransact(
        BluetoothAvrcpCtObserverInterfaceCode::AVRCP_CT_GET_PLAYER_APP_SETTING_VALUES, option, data, reply);
    if (error != NO_ERROR) {
        HILOGE("error: %{public}d", error);
        return;
    }
    ...
    const RawAddress &rawAddr, const std::vector<uint8_t> attributes, const std::vector<uint8_t> &values, int result)
{
    ...
    MessageOption option = {MessageOption::TF_ASYNC};
    int error = InnerTransact(
        BluetoothAvrcpCtObserverInterfaceCode::AVRCP_CT_GET_PLAYER_APP_SETTING_CURRENT_VALUE, option, data, reply);
    if (error != NO_ERROR) {
        HILOGE("error: %{public}d", error);
        return;
    }
...
void BluetoothAvrcpCtObserverProxy::OnSetPlayerAppSettingCurrentValue(const RawAddress &rawAddr, int result)
{
    ...
    MessageOption option = {MessageOption::TF_ASYNC};
    int error = InnerTransact(
        BluetoothAvrcpCtObserverInterfaceCode::AVRCP_CT_SET_PLAYER_APP_SETTING_CURRENT_VALUE, option, data, reply);
    if (error != NO_ERROR) {
        HILOGE("error: %{public}d", error);
        return;
    }
    ...
    const std::vector<uint8_t> attribtues, const std::vector<std::string> &attributeName, int result)
{
    ...
    MessageOption option = {MessageOption::TF_ASYNC};
    int error = InnerTransact(
        BluetoothAvrcpCtObserverInterfaceCode::AVRCP_CT_GET_PLAYER_APP_SETTING_ATTRIBUTE_TEXT, option, data, reply);
    if (error != NO_ERROR) {
        HILOGE("error: %{public}d", error);
        return;
    }
    ...
    const std::vector<uint8_t> &values, const std::vector<std::string> &valueName, int result)
{
    ...
    MessageOption option = {MessageOption::TF_ASYNC};
    int error = InnerTransact(
        BluetoothAvrcpCtObserverInterfaceCode::AVRCP_CT_GET_PLAYER_APP_SETTING_VALUE_TEXT, option, data, reply);
    if (error != NO_ERROR) {
        HILOGE("error: %{public}d", error);
        return;
    }
    ...
    const std::vector<uint32_t> &attribtues, const std::vector<std::string> &valueName, int result)
{
    ...
    MessageOption option = {MessageOption::TF_ASYNC};
    int error = InnerTransact(
        BluetoothAvrcpCtObserverInterfaceCode::AVRCP_CT_ELEMENT_ATTRIBUTRES, option, data, reply);
    if (error != NO_ERROR) {
        HILOGE("error: %{public}d", error);
        return;
    }
    ...
    uint32_t songLength, uint32_t songPosition, uint8_t playStatus, int result)
{
    ...
    MessageOption option = {MessageOption::TF_ASYNC};
    int error = InnerTransact(
        BluetoothAvrcpCtObserverInterfaceCode::AVRCP_CT_GET_PLAY_STATUS, option, data, reply);
    if (error != NO_ERROR) {
        HILOGE("error: %{public}d", error);
        return;
    }
...
void BluetoothAvrcpCtObserverProxy::OnPlayItem(const RawAddress &rawAddr, int status, int result)
{
    ...
    MessageOption option = {MessageOption::TF_ASYNC};
    int error = InnerTransact(
        BluetoothAvrcpCtObserverInterfaceCode::AVRCP_CT_PLAY_ITEM, option, data, reply);
    if (error != NO_ERROR) {
        HILOGE("error: %{public}d", error);
        return;
    }
    ...
    uint16_t uidCounter, uint32_t numOfItems, int result, int detail)
{
    ...
    MessageOption option = {MessageOption::TF_ASYNC};
    int error = InnerTransact(
        BluetoothAvrcpCtObserverInterfaceCode::AVRCP_CT_GET_TOTAL_NUMBER_OF_ITEMS, option, data, reply);
    if (error != NO_ERROR) {
        HILOGE("error: %{public}d", error);
        return;
    }
    ...
    const std::vector<uint32_t> &attribtues, const std::vector<std::string> &values, int result, int detail)
{
    ...
    MessageOption option = {MessageOption::TF_ASYNC};
    int error = InnerTransact(
        BluetoothAvrcpCtObserverInterfaceCode::AVRCP_CT_GET_ITEM_ATTRIBUTES, option, data, reply);
    if (error != NO_ERROR) {
        HILOGE("error: %{public}d", error);
        return;
    }
...
void BluetoothAvrcpCtObserverProxy::OnSetAbsoluteVolume(const RawAddress &rawAddr, uint8_t volume, int result)
{
    ...
    MessageOption option = {MessageOption::TF_ASYNC};
    int error = InnerTransact(
        BluetoothAvrcpCtObserverInterfaceCode::AVRCP_CT_SET_ABSOLUTE_VOLUME, option, data, reply);
    if (error != NO_ERROR) {
        HILOGE("error: %{public}d", error);
        return;
    }
...
void BluetoothAvrcpCtObserverProxy::OnPlaybackStatusChanged(const RawAddress &rawAddr, uint8_t playStatus, int result)
{
    ...
    MessageOption option = {MessageOption::TF_ASYNC};
    int error = InnerTransact(
        BluetoothAvrcpCtObserverInterfaceCode::AVRCP_CT_PLAYBACK_STATUS_CHANGED, option, data, reply);
    if (error != NO_ERROR) {
        HILOGE("error: %{public}d", error);
        return;
    }
...
void BluetoothAvrcpCtObserverProxy::OnTrackChanged(const RawAddress &rawAddr, uint64_t uid, int result)
{
    ...
    MessageOption option = {MessageOption::TF_ASYNC};
    int error = InnerTransact(
        BluetoothAvrcpCtObserverInterfaceCode::AVRCP_CT_TRACK_CHANGED, option, data, reply);
    if (error != NO_ERROR) {
        HILOGE("error: %{public}d", error);
        return;
    }
...
void BluetoothAvrcpCtObserverProxy::OnTrackReachedEnd(const RawAddress &rawAddr, int result)
{
    ...
    MessageOption option = {MessageOption::TF_ASYNC};
    int error = InnerTransact(
        BluetoothAvrcpCtObserverInterfaceCode::AVRCP_CT_TRACK_REACHED_END, option, data, reply);
    if (error != NO_ERROR) {
        HILOGE("error: %{public}d", error);
        return;
    }
...
void BluetoothAvrcpCtObserverProxy::OnTrackReachedStart(const RawAddress &rawAddr, int result)
{
    ...
    MessageOption option = {MessageOption::TF_ASYNC};
    int error = InnerTransact(
        BluetoothAvrcpCtObserverInterfaceCode::AVRCP_CT_TRACK_REACHED_START, option, data, reply);
    if (error != NO_ERROR) {
        HILOGE("error: %{public}d", error);
        return;
    }
...
void BluetoothAvrcpCtObserverProxy::OnPlaybackPosChanged(const RawAddress &rawAddr, uint32_t playbackPos, int result)
{
    ...
    MessageOption option = {MessageOption::TF_ASYNC};
    int error = InnerTransact(
        BluetoothAvrcpCtObserverInterfaceCode::AVRCP_CT_PLAYBACK_POS_CHANGED, option, data, reply);
    if (error != NO_ERROR) {
        HILOGE("error: %{public}d", error);
        return;
    }
...
void BluetoothAvrcpCtObserverProxy::OnPlayerAppSettingChanged(
    const RawAddress &rawAddr, const std::vector<uint8_t> &attributes, const std::vector<uint8_t> &values, int result)
{
    MessageParcel data;
    if (!data.WriteInterfaceToken(BluetoothAvrcpCtObserverProxy::GetDescriptor())) {
    ...
    MessageOption option = {MessageOption::TF_ASYNC};
    int error = InnerTransact(
        BluetoothAvrcpCtObserverInterfaceCode::AVRCP_CT_PLAY_APP_SETTING_CHANGED, option, data, reply);
    if (error != NO_ERROR) {
        HILOGE("error: %{public}d", error);
        return;
    }
...
void BluetoothAvrcpCtObserverProxy::OnNowPlayingContentChanged(const RawAddress &rawAddr, int result)
{
    ...
    MessageOption option = {MessageOption::TF_ASYNC};
    int error = InnerTransact(
        BluetoothAvrcpCtObserverInterfaceCode::AVRCP_CT_NOW_PLAYING_CONTENT_CHANGED, option, data, reply);
    if (error != NO_ERROR) {
        HILOGE("error: %{public}d", error);
        return;
    }
...
void BluetoothAvrcpCtObserverProxy::OnAvailablePlayersChanged(const RawAddress &rawAddr, int result)
{
    ...
    MessageOption option = {MessageOption::TF_ASYNC};
    int error = InnerTransact(
        BluetoothAvrcpCtObserverInterfaceCode::AVRCP_CT_AVAILABLE_PLAYER_CHANGED, option, data, reply);
    if (error != NO_ERROR) {
        HILOGE("error: %{public}d", error);
        return;
    }
    ...
    const RawAddress &rawAddr, uint16_t playerId, uint16_t uidCounter, int result)
{
    ...
    MessageOption option = {MessageOption::TF_ASYNC};
    int error = InnerTransact(
        BluetoothAvrcpCtObserverInterfaceCode::AVRCP_CT_ADDRESSED_PLAYER_CHANGED, option, data, reply);
    if (error != NO_ERROR) {
        HILOGE("error: %{public}d", error);
        return;
    }
...
void BluetoothAvrcpCtObserverProxy::OnUidChanged(const RawAddress &rawAddr, uint16_t uidCounter, int result)
{
    ...
    MessageOption option = {MessageOption::TF_ASYNC};
    int error = InnerTransact(
        BluetoothAvrcpCtObserverInterfaceCode::AVRCP_CT_UID_CHANGED, option, data, reply);
    if (error != NO_ERROR) {
        HILOGE("error: %{public}d", error);
        return;
    }
...
void BluetoothAvrcpCtObserverProxy::OnVolumeChanged(const RawAddress &rawAddr, uint8_t volume, int result)
{
    ...
    MessageOption option = {MessageOption::TF_ASYNC};
    int error = InnerTransact(
        BluetoothAvrcpCtObserverInterfaceCode::AVRCP_CT_VOLUME_CHANGED, option, data, reply);
    if (error != NO_ERROR) {
        HILOGE("error: %{public}d", error);
        return;
    }
    ...
    std::vector<BluetoothAvrcpMpItem> &items, int result, int detail)
{
    ...
    MessageOption option = {MessageOption::TF_ASYNC};
    int error = InnerTransact(
        BluetoothAvrcpCtObserverInterfaceCode::AVRCP_CT_GET_MEDIA_PLAYERS, option, data, reply);
    if (error != NO_ERROR) {
        HILOGE("error: %{public}d", error);
        return;
    }
...
void BluetoothAvrcpCtObserverProxy::OnGetFolderItems(
    const RawAddress &rawAddr, uint16_t uidCounter, std::vector<BluetoothAvrcpMeItem> &items, int result, int detail)
{
    MessageParcel data;
    if (!data.WriteInterfaceToken(BluetoothAvrcpCtObserverProxy::GetDescriptor())) {
    ...
    MessageOption option = {MessageOption::TF_ASYNC};
    int error = InnerTransact(
        BluetoothAvrcpCtObserverInterfaceCode::AVRCP_CT_GET_FOLDER_ITEMS, option, data, reply);
    if (error != NO_ERROR) {
        HILOGE("error: %{public}d", error);
        return;
    }
...
ErrCode BluetoothAvrcpCtObserverProxy::InnerTransact(BluetoothAvrcpCtObserverInterfaceCode interfaceCode,
