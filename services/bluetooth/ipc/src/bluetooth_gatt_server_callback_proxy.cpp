 ...
 */
#ifndef LOG_TAG
#define LOG_TAG "bt_ipc_gatt_server_obs_proxy"
#endif
    ...
    const BluetoothGattDevice &device, const BluetoothGattCharacteristic &characteristic)
{
    ...
    if (error != NO_ERROR) {
        HILOGE("BluetoothGattServerCallbackProxy::OnCharacteristicReadRequest done fail, error: %{public}d", error);
        return;
    }
    return;
}
...
{
    HILOGD("BluetoothGattServerCallbackProxy::OnConnectionStateChanged Triggered!");
    MessageParcel data;
    if (!data.WriteInterfaceToken(BluetoothGattServerCallbackProxy::GetDescriptor())) {
    ...
    if (!data.WriteParcelable(&device)) {
        HILOGE("BluetoothGattServerCallbackProxy::OnConnectionStateChanged write device error");
        return;
    }
    if (!data.WriteInt32(ret)) {
        HILOGE("BluetoothGattServerCallbackProxy::OnConnectionStateChanged write ret error");
        return;
    }
    if (!data.WriteInt32(state)) {
        HILOGE("BluetoothGattServerCallbackProxy::OnConnectionStateChanged write state error");
        return;
    }
    if (!data.WriteInt32(disconnectReason)) {
        HILOGE("BluetoothGattServerCallbackProxy::OnConnectionStateChanged write reason error");
        return;
    }
    ...
    if (error != NO_ERROR) {
        HILOGE("BluetoothGattServerCallbackProxy::OnConnectionStateChanged done fail, error: %{public}d", error);
        return;
    }
    return;
}
void BluetoothGattServerCallbackProxy::OnAddService(int32_t ret, const BluetoothGattService &service)
{
    ...
    if (error != NO_ERROR) {
        HILOGE("BluetoothGattServerCallbackProxy::OnAddService done fail, error: %{public}d", error);
        return;
    }
    return;
}
    ...
    const BluetoothGattDevice &device, const BluetoothGattCharacteristic &characteristic, bool needRespones)
{
    ...
    int error = remote->SendRequest(
        ...
        data, reply, option);
    if (error != NO_ERROR) {
        HILOGE("BluetoothGattServerCallbackProxy::OnCharacteristicWriteRequest done fail, error: %{public}d", error);
        return;
    }
    return;
}
    ...
    const BluetoothGattDevice &device, const BluetoothGattDescriptor &descriptor)
{
    ...
    if (error != NO_ERROR) {
        HILOGE("BluetoothGattServerCallbackProxy::OnDescriptorReadRequest done fail, error: %{public}d", error);
        return;
    }
    return;
}
    ...
    const BluetoothGattDevice &device, const BluetoothGattDescriptor &descriptor)
{
    ...
    if (error != NO_ERROR) {
        HILOGE("BluetoothGattServerCallbackProxy::OnDescriptorWriteRequest done fail, error: %{public}d", error);
        return;
    }
    return;
}
void BluetoothGattServerCallbackProxy::OnMtuChanged(const BluetoothGattDevice &device, int32_t mtu)
{
    ...
    if (error != NO_ERROR) {
        HILOGE("BluetoothGattServerCallbackProxy::OnMtuUpdateOnMtuChanged done fail, error: %{public}d", error);
        return;
    }
    return;
}
    ...
    const BluetoothGattDevice &device, const BluetoothGattCharacteristic &characteristic, int result)
{
    ...
    if (error != NO_ERROR) {
        HILOGE("BluetoothGattServerCallbackProxy::OnNotifyConfirm done fail, error: %{public}d", error);
        return;
    }
    return;
}
    ...
    const BluetoothGattDevice &device, int32_t interval, int32_t latency, int32_t timeout, int32_t status)
{
    ...
    int error = remote->SendRequest(
        ...
        data, reply, option);
    if (error != NO_ERROR) {
        HILOGE("BluetoothGattServerCallbackProxy::OnConnectionParameterChanged done fail, error: %{public}d", error);
        return;
    }
    return;
}
    ...
    const BluetoothGattDevice &device, int32_t txPhy, int32_t rxPhy, int32_t status)
{
    ...
    int error = remote->SendRequest(
        ...
        data, reply, option);
    if (error != NO_ERROR) {
        HILOGE("BluetoothGattServerCallbackProxy::OnBlePhyUpdate done fail, error: %{public}d", error);
        return;
    }
    return;
}
...
void BluetoothGattServerCallbackProxy::OnBlePhyRead(int32_t txPhy, int32_t rxPhy, int32_t status)
{
    ...
    int error = remote->SendRequest(
        ...
        data, reply, option);
    if (error != NO_ERROR) {
        HILOGE("BluetoothGattServerCallbackProxy::OnBlePhyRead done fail, error: %{public}d", error);
        return;
    }
    return;
}
