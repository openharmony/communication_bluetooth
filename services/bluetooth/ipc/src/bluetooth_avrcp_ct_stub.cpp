 ...
 */
#ifndef LOG_TAG
#define LOG_TAG "bt_ipc_avrcp_ct_stub"
#endif
...
#undef STUB_FUNC
#endif
#define STUB_FUNC(code, func, perm) BluetoothAvrcpCtInterfaceCode::code, {&BluetoothAvrcpCtStub::func, perm}

namespace OHOS {
namespace Bluetooth {
const uint32_t AVRCP_NOTIFICATION_EVENT_COUNT_MAX = 0xFF;
...
const std::map<uint32_t, BluetoothAvrcpCtStub::AvrcpCtStubFuncPerm> BluetoothAvrcpCtStub::memberFuncMap_ = {
    // Note: Permissions need to be configured when the AVRCP CT starts to be used.
    {STUB_FUNC(AVRCP_CT_REGISTER_OBSERVER, RegisterObserverInner, nullptr)},
    {STUB_FUNC(AVRCP_CT_UNREGISTER_OBSERVER, UnregisterObserverInner, nullptr)},
    {STUB_FUNC(AVRCP_CT_GET_CONNECTED_DEVICES, GetConnectedDevicesInner, nullptr)},
    {STUB_FUNC(AVRCP_CT_GET_DEVICES_BY_STATES, GetDevicesByStatesInner, nullptr)},
    {STUB_FUNC(AVRCP_CT_GET_DEVICE_STATE, GetDeviceStateInner, nullptr)},
    {STUB_FUNC(AVRCP_CT_CONNECT, ConnectInner,
        CHECK_PERM(false, {}, MULTI_PERM(ACCESS_BLUETOOTH, MANAGE_BLUETOOTH)))},
    {STUB_FUNC(AVRCP_CT_DISCONNECT, DisconnectInner,
        CHECK_PERM(false, {}, MULTI_PERM(ACCESS_BLUETOOTH, MANAGE_BLUETOOTH)))},
    {STUB_FUNC(AVRCP_CT_PRESS_BUTTON, PressButtonnner,
        CHECK_PERM(false, {}, MULTI_PERM(ACCESS_BLUETOOTH, MANAGE_BLUETOOTH)))},
    {STUB_FUNC(AVRCP_CT_RELEASE_BUTTON, ReleaseButtonInner,
        CHECK_PERM(false, {}, MULTI_PERM(ACCESS_BLUETOOTH, MANAGE_BLUETOOTH)))},
    {STUB_FUNC(AVRCP_CT_GET_UNIT_INFO, GetUnitInfoInner,
        CHECK_PERM(false, {}, MULTI_PERM(ACCESS_BLUETOOTH, MANAGE_BLUETOOTH)))},
    {STUB_FUNC(AVRCP_CT_GET_SUB_UNIT_INFO, GetSubUnitInfoInner,
        CHECK_PERM(false, {}, MULTI_PERM(ACCESS_BLUETOOTH, MANAGE_BLUETOOTH)))},
    {STUB_FUNC(AVRCP_CT_GET_SUPPORTED_COMPANIES, GetSupportedCompaniesInner,
        CHECK_PERM(false, {}, MULTI_PERM(ACCESS_BLUETOOTH, MANAGE_BLUETOOTH)))},
    {STUB_FUNC(AVRCP_CT_GET_SUPPORTED_EVENTS, GetSupportedEventsInner,
        CHECK_PERM(false, {}, MULTI_PERM(ACCESS_BLUETOOTH, MANAGE_BLUETOOTH)))},
    {STUB_FUNC(AVRCP_CT_GET_PLAYER_APP_SETTING_ATTRIBUTES, GetPlayerAppSettingAttributesInner,
        CHECK_PERM(false, {}, MULTI_PERM(ACCESS_BLUETOOTH, MANAGE_BLUETOOTH)))},
    {STUB_FUNC(AVRCP_CT_GET_PLAYER_APP_SETTING_VALUES, GetPlayerAppSettingValuesInner,
        CHECK_PERM(false, {}, MULTI_PERM(ACCESS_BLUETOOTH, MANAGE_BLUETOOTH)))},
    {STUB_FUNC(AVRCP_CT_GET_PLAYER_APP_SETTING_CURRENT_VALUE, GetPlayerAppSettingCurrentValueInner,
        CHECK_PERM(false, {}, MULTI_PERM(ACCESS_BLUETOOTH, MANAGE_BLUETOOTH)))},
    {STUB_FUNC(AVRCP_CT_SET_PLAYER_APP_SETTING_CURRENT_VALUE, SetPlayerAppSettingCurrentValueInner,
        CHECK_PERM(false, {}, MULTI_PERM(ACCESS_BLUETOOTH, MANAGE_BLUETOOTH)))},
    {STUB_FUNC(AVRCP_CT_GET_PLAYER_APP_SETTING_ATTRIBUTE_TEXT, GetPlayerAppSettingAttributeTextInner,
        CHECK_PERM(false, {}, MULTI_PERM(ACCESS_BLUETOOTH, MANAGE_BLUETOOTH)))},
    {STUB_FUNC(AVRCP_CT_GET_PLAYER_APP_SETTING_VALUES_TEXT, GetPlayerAppSettingValueTextInner,
        CHECK_PERM(false, {}, MULTI_PERM(ACCESS_BLUETOOTH, MANAGE_BLUETOOTH)))},
    {STUB_FUNC(AVRCP_CT_GET_ELEMENT_ATTRIBUTES, GetElementAttributesInner,
        CHECK_PERM(false, {}, MULTI_PERM(ACCESS_BLUETOOTH, MANAGE_BLUETOOTH)))},
    {STUB_FUNC(AVRCP_CT_GET_PLAYER_STATUS, GetPlayStatusInner,
        CHECK_PERM(false, {}, MULTI_PERM(ACCESS_BLUETOOTH, MANAGE_BLUETOOTH)))},
    {STUB_FUNC(AVRCP_CT_PLAY_ITEM, PlayItemInner,
        CHECK_PERM(false, {}, MULTI_PERM(ACCESS_BLUETOOTH, MANAGE_BLUETOOTH)))},
    {STUB_FUNC(AVRCP_CT_GET_FOLDER_ITEMS, GetFolderItemsInner,
        CHECK_PERM(false, {}, MULTI_PERM(ACCESS_BLUETOOTH, MANAGE_BLUETOOTH)))},
    {STUB_FUNC(AVRCP_CT_GET_TOTAL_NUMBER_OF_ITEMS, GetTotalNumberOfItemsInner,
        CHECK_PERM(false, {}, MULTI_PERM(ACCESS_BLUETOOTH, MANAGE_BLUETOOTH)))},
    {STUB_FUNC(AVRCP_CT_SET_ABSOLUTE_VOLUME, SetAbsoluteVolumeInner,
        CHECK_PERM(false, {}, MULTI_PERM(ACCESS_BLUETOOTH, MANAGE_BLUETOOTH)))},
    {STUB_FUNC(AVRCP_CT_ENABLE_NOTIFICATION, EnableNotificationInner,
        CHECK_PERM(false, {}, MULTI_PERM(ACCESS_BLUETOOTH, MANAGE_BLUETOOTH)))},
    {STUB_FUNC(AVRCP_CT_DISABLE_NOTIFICATION, DisableNotificationInner,
        CHECK_PERM(false, {}, MULTI_PERM(ACCESS_BLUETOOTH, MANAGE_BLUETOOTH)))},
    {STUB_FUNC(AVRCP_CT_GET_ITEM_ATTRIBUTES, GetItemAttributesInner,
        CHECK_PERM(false, {}, MULTI_PERM(ACCESS_BLUETOOTH, MANAGE_BLUETOOTH)))},
    {STUB_FUNC(AVRCP_CT_SET_BROWSERED_PLAYER, SetBrowsedPlayerInner,
        CHECK_PERM(false, {}, MULTI_PERM(ACCESS_BLUETOOTH, MANAGE_BLUETOOTH)))},
    {STUB_FUNC(AVRCP_CT_MEDIA_PLAYER_LIST, GetMeidaPlayerListInner,
        CHECK_PERM(false, {}, MULTI_PERM(ACCESS_BLUETOOTH, MANAGE_BLUETOOTH)))},
};
...
{
    std::string name = "BluetoothAvrcpCt ipcCode: " + std::to_string(code);
...
ErrCode BluetoothAvrcpCtStub::GetDeviceStateInner(MessageParcel &data, MessageParcel &reply)
{
    ...
    int32_t state = GetDeviceState(RawAddress(addr));
...
ErrCode BluetoothAvrcpCtStub::PressButtonnner(MessageParcel &data, MessageParcel &reply)
{
    std::string addr = data.ReadString();
    CHECK_AND_RETURN_LOG_RET(IsValidAddr(addr), BT_ERR_INVALID_PARAM, "addr is invalid.");
    int32_t result = PressButton(RawAddress(addr), data.ReadInt32());
    reply.WriteInt32(result);
...
ErrCode BluetoothAvrcpCtStub::ReleaseButtonInner(MessageParcel &data, MessageParcel &reply)
{
    std::string addr = data.ReadString();
    CHECK_AND_RETURN_LOG_RET(IsValidAddr(addr), BT_ERR_INVALID_PARAM, "addr is invalid.");
    int32_t result = ReleaseButton(RawAddress(addr), data.ReadInt32());
    reply.WriteInt32(result);
...
ErrCode BluetoothAvrcpCtStub::GetUnitInfoInner(MessageParcel &data, MessageParcel &reply)
{
    std::string addr = data.ReadString();
    CHECK_AND_RETURN_LOG_RET(IsValidAddr(addr), BT_ERR_INVALID_PARAM, "addr is invalid.");
    int32_t result = GetUnitInfo(RawAddress(addr));
    reply.WriteInt32(result);
...
ErrCode BluetoothAvrcpCtStub::GetSubUnitInfoInner(MessageParcel &data, MessageParcel &reply)
{
    std::string addr = data.ReadString();
    CHECK_AND_RETURN_LOG_RET(IsValidAddr(addr), BT_ERR_INVALID_PARAM, "addr is invalid.");
    int32_t result = GetSubUnitInfo(RawAddress(addr));
    reply.WriteInt32(result);
...
ErrCode BluetoothAvrcpCtStub::GetSupportedCompaniesInner(MessageParcel &data, MessageParcel &reply)
{
    std::string addr = data.ReadString();
    CHECK_AND_RETURN_LOG_RET(IsValidAddr(addr), BT_ERR_INVALID_PARAM, "addr is invalid.");
    int32_t result = GetSupportedCompanies(RawAddress(addr));
    reply.WriteInt32(result);
...
ErrCode BluetoothAvrcpCtStub::GetSupportedEventsInner(MessageParcel &data, MessageParcel &reply)
{
    std::string addr = data.ReadString();
    CHECK_AND_RETURN_LOG_RET(IsValidAddr(addr), BT_ERR_INVALID_PARAM, "addr is invalid.");
    int32_t result = GetSupportedEvents(RawAddress(addr));
    reply.WriteInt32(result);
...
ErrCode BluetoothAvrcpCtStub::GetPlayerAppSettingAttributesInner(MessageParcel &data, MessageParcel &reply)
{
    std::string addr = data.ReadString();
    CHECK_AND_RETURN_LOG_RET(IsValidAddr(addr), BT_ERR_INVALID_PARAM, "addr is invalid.");
    int32_t result = GetPlayerAppSettingAttributes(RawAddress(addr));
    reply.WriteInt32(result);
...
ErrCode BluetoothAvrcpCtStub::GetPlayerAppSettingValuesInner(MessageParcel &data, MessageParcel &reply)
{
    std::string addr = data.ReadString();
    CHECK_AND_RETURN_LOG_RET(IsValidAddr(addr), BT_ERR_INVALID_PARAM, "addr is invalid.");
    int32_t result = GetPlayerAppSettingValues(RawAddress(addr), data.ReadInt32());
    reply.WriteInt32(result);
...
ErrCode BluetoothAvrcpCtStub::GetPlayerAppSettingCurrentValueInner(MessageParcel &data, MessageParcel &reply)
{
    std::string addr = data.ReadString();
    CHECK_AND_RETURN_LOG_RET(IsValidAddr(addr), BT_ERR_INVALID_PARAM, "addr is invalid.");
    RawAddress raw = RawAddress(addr);
...
ErrCode BluetoothAvrcpCtStub::EnableNotificationInner(MessageParcel &data, MessageParcel &reply)
{
    ...
    int32_t attributesSize = data.ReadInt32();
    if (static_cast<uint32_t>(attributesSize) > AVRCP_NOTIFICATION_EVENT_COUNT_MAX) {
