...
public:
     ...
     */
    virtual void OnConnectionStateChanged(const RawAddress &deviceAddress, int state, int cause) {};
};
...
public:
    ...
    /**
     * @brief Restart Stack Hid Profile.
     */
    virtual void ReStartStackHidProfile(void) = 0;
};
}  // namespace bluetooth
}  // namespace OHOS
