...
public:
     ...
     * @since 23
     */
    virtual int32_t GenerateLocalOobData(int32_t transport) const = 0;
     ...
     * @since 6
     */
    virtual std::string GetDeviceName(const RawAddress &device, bool alias = true) const = 0;
    ...
    /**
     * @brief Start pair with a remote device.
     *
     * @param transport Indicates the transport of a remote Bluetooth device.
     * @param device Remote device address.
     * @return Returns <b>true</b> if the operation is successful;
     *         returns <b>false</b> if the operation fails.
     * @since 6
     ...
     * @since 23
     */
    virtual bool StartPair(int32_t transport, const RawAddress &device, const Bluetooth::BluetoothOobData &oobData) = 0;
     ...
     * @since 10
     */
    virtual bool StartCrediblePair(int32_t transport, const RawAddress &device) = 0;
     ...
     * @since 6
     */
    virtual bool RemovePair(int32_t transport, const RawAddress &device) = 0;
