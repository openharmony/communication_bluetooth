...
public:
     ...
     */
    virtual void OnConnectionStateChanged(const bluetooth::RawAddress &deviceAddress, int state, int cause, int role) {}
};

class IProfilePan : public bluetooth::IProfile {
public:
    /**
     ...
     */
    virtual int GetDeviceState(const bluetooth::RawAddress &device) = 0;

    virtual int SetTethering(const bool enable) = 0;
