...
constexpr const char *PROFILE_NAME_HID_DEVICE = "HidDeviceService";
constexpr const char *PROFILE_NAME_HEARING_AID = "HearingAidService";
constexpr const char *PROFILE_NAME_BAS = "BasService";
