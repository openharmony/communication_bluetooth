...
public:
     ...
     *
     */
    virtual void OnConnectionStateChanged(const GattDevice &device, int ret, int state, int disconnectReason = -1,
    ...
    virtual void OnBlePhyUpdate(const GattDevice &device, int32_t txPhy, int32_t rxPhy, int32_t status) {}
...
public:
     ...
     *
     */
    virtual int RegisterApplication(std::weak_ptr<IGattServerCallback> callback) = 0;
    /**
     ...
     * @since 6
     */
    virtual int Connect(int appId, const GattDevice &device, bool isDirect) = 0;
    /**
     ...
     *
     */
    virtual int CancelConnection(int appId, const GattDevice &device) = 0;

    virtual int GetConnectedState(const RawAddress &address) = 0;

    virtual int SetPhy(int appId, const RawAddress &address, int txPhy, int rxPhy, int phyOptions) = 0;
 
    virtual int ReadPhy(int appId, const RawAddress &address) = 0;
