...
public:
     ...
     */
    virtual void SetDeviceAbsVolumeAbility(const RawAddress &addr, int32_t ability) = 0;

    /**
     * @brief get Device abs volume ability.
     * @param[in] addr The device.
     * @return The device abs volume ability.
     */
    virtual int32_t GetDeviceAbsVolumeAbility(const RawAddress &addr) = 0;
     ...
     */
    virtual void SetDeviceAbsoluteVolume(const RawAddress &addr, int32_t volumeLevel) = 0;
