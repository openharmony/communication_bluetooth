...
const std::string PROPERTY_HIGH_PRIORITY_MIN_INTERVAL = HIGH_PRIORITY_MIN_INTERVAL;
...
const std::string PROPERTY_LOW_POWER_WEAK_MIN_INTERVAL = "LowPowerWeakMinInterval";
const std::string PROPERTY_LOW_POWER_ENHANCE_MIN_INTERVAL = "LowPowerEnhanceMinInterval";
const std::string PROPERTY_LOW_POWER_ULTRA_MIN_INTERVAL = "LowPowerUltraMinInterval";
...
const std::string PROPERTY_LOW_POWER_WEAK_MAX_INTERVAL = "LowPowerWeakMaxInterval";
const std::string PROPERTY_LOW_POWER_ENHANCE_MAX_INTERVAL = "LowPowerEnhanceMaxInterval";
const std::string PROPERTY_LOW_POWER_ULTRA_MAX_INTERVAL = "LowPowerUltraMaxInterval";
...
const std::string PROPERTY_LOW_POWER_WEAK_LATENCY = "LowPowerWeakLatency";
const std::string PROPERTY_LOW_POWER_ENHANCE_LATENCY = "LowPowerEnhanceLatency";
const std::string PROPERTY_LOW_POWER_ULTRA_LATENCY = "LowPowerUltraLatency";
...
const std::string PROPERTY_LOW_POWER_WEAK_TIMEOUT = "LowPowerWeakTimeout";
const std::string PROPERTY_LOW_POWER_ENHANCE_TIMEOUT = "LowPowerEnhanceTimeout";
const std::string PROPERTY_LOW_POWER_ULTRA_TIMEOUT = "LowPowerUltraTimeout";
...
const std::string PROPERTY_CODEC_LDAC_SUPPORT = "CodecLdacSupport";
const std::string PROPERTY_CODEC_L2HCV2_SUPPORT = "CodecL2hcV2Support";
const std::string PROPERTY_CODEC_L2HCST_SUPPORT = "CodecL2hcStSupport";
