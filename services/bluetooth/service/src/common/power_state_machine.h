...
public:
     ...
     * @since 6
     */
    ~PowerStateMachine() override = default;
...
public:
     ...
     * @since 6
     */
    ~PowerActiveState() override = default;
...
public:
     ...
     * @since 6
     */
    ~PowerActiveActivingState() override = default;
    void Entry() override;
    void Exit() override;
    bool Dispatch(const utility::Message &msg) override;
};
...
public:
     ...
     * @since 6
     */
    ~PowerActiveSniffingState() override = default;
    void Entry() override;
    void Exit() override;
    bool Dispatch(const utility::Message &msg) override;
};
...
public:
     ...
     * @since 6
     */
    ~PowerSniffState() override = default;
    void Entry() override;
    void Exit() override;
    bool Dispatch(const utility::Message &msg) override;
};
...
public:
     ...
     * @since 6
     */
    ~PowerSniffActivingState() override = default;
    void Entry() override;
    void Exit() override;
    bool Dispatch(const utility::Message &msg) override;
};
...
public:
     ...
     * @since 6
     */
    ~PowerSniffSniffingState() override = default;
    void Entry() override;
    void Exit() override;
    bool Dispatch(const utility::Message &msg) override;
};
