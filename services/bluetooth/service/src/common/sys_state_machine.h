...
public:
     ...
     * @since 6
     */
    ~SysStateMachine() override = default;
...
public:
     ...
     * @since 6
     */
    ~SysStoppingBaseState() override = default;
...
public:
     ...
     * @since 6
     */
    ~SysStoppedState() override = default;
...
public:
     ...
     * @since 6
     */
    ~SysStartedState() override = default;
...
public:
     ...
     * @since 6
     */
    ~SysStoppingState() override = default;
...
public:
     ...
     * @since 6
     */
    ~SysResettingState() override = default;
...
public:
     ...
     * @since 6
     */
    ~SysFactoryResettingState() override = default;
