...
public:
    ...
    static void BondStateChangedCb(bt_status_t status, BLUEDROID::RawAddress* bdAddr, bt_bond_state_t state);
    static void SspRequestCb(BLUEDROID::RawAddress* remoteBdAddr, bt_bdname_t* bdName, uint32_t cod,
                             bt_ssp_variant_t pairingVariant, uint32_t passKey);
    static void AclStateChangedCb(bt_status_t status, BLUEDROID::RawAddress* remoteBdAddr, bt_acl_state_t state,
    ...
    static void RemoteDevicePropertiesCb(bt_status_t status, BLUEDROID::RawAddress* bdAddr,
                                         int numProperties, bt_property_t* properties);
    static void ThreadEvtCb(bt_cb_thread_evt evt);
    static void PinRequestCb(BLUEDROID::RawAddress* remoteBdAddr, bt_bdname_t* bdName, uint32_t cod,
        bool min16Digit);
