...
void AvrcpServiceManager::SetDeviceAbsVolumeProperty(const OHOS::bluetooth::RawAddress &rawAddr, int32_t ability)
{
...
void AvrcpServiceManager::SetActiveDevice(const RawAddress &rawAddr)
{
    if (avrcpServiceInterface_ != nullptr && mediaLoader_ != nullptr) {
        ...
        mediaLoader_->SetActiveDevice(rawAddr);
    } else {
