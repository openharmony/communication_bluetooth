...
namespace bluetooth {
/// const
const uint8_t BLE_IRK_HEX_ELN = 0x10;
const uint8_t BLE_IRK_RAND_HEX_LEN = 0x03;
const uint8_t BLE_IRK_RAND_ELN = 0x1F;
const uint8_t BLE_IRK_RAND_LEFT_SHIFT = 0x04;
const uint8_t SHORTENED_LOCAL_NAME = 0X08;
const uint8_t COMPLETE_LOCAL_NAME = 0X09;
const uint8_t MANUFACTURER_SPECIFIC_DATA = 0XFF;
const uint8_t TX_POWER_LEVEL = 0x0A;
const uint8_t SERVICE_DATA_16_BIT_UUID = 0X16;
const uint8_t SERVICE_DATA_32_BIT_UUID = 0X20;
const uint8_t SERVICE_DATA_128_BIT_UUID = 0X21;
const uint8_t BLE_DIV_RESULT_TWO = 0x02;

/// Maximum advertising data length that can fit in a legacy PDU.
const uint8_t BLE_LEGACY_ADV_DATA_LEN_MAX = 0x1F;
const uint8_t BLE_LEGACY_SCAN_RSP_DATA_LEN_MAX = 0x1F;
const uint8_t BLE_EX_ADV_PAYLOAD_DATA_LEN = 0XBF;

/// Regular scan params
const uint16_t BLE_SCAN_MODE_LOW_POWER_WINDOW_MS = 512;
const uint16_t BLE_SCAN_MODE_LOW_POWER_INTERVAL_MS = 5120;
const uint16_t BLE_SCAN_MODE_BALANCED_WINDOW_MS = 1024;
const uint16_t BLE_SCAN_MODE_BALANCED_INTERVAL_MS = 4096;
const uint16_t BLE_SCAN_MODE_LOW_LATENCY_WINDOW_MS = 4096;
const uint16_t BLE_SCAN_MODE_LOW_LATENCY_INTERVAL_MS = 4096;

/// Batch scan params
const uint16_t BLE_SCAN_MODE_BATCH_LOW_POWER_WINDOW_MS = 500;
const uint16_t BLE_SCAN_MODE_BATCH_LOW_POWER_INTERVAL_MS = 45000;
const uint16_t BLE_SCAN_MODE_BATCH_BALANCED_WINDOW_MS = 1000;
const uint16_t BLE_SCAN_MODE_BATCH_BALANCED_INTERVAL_MS = 45000;
const uint16_t BLE_SCAN_MODE_BATCH_LOW_LATENCY_WINDOW_MS = 1500;
const uint16_t BLE_SCAN_MODE_BATCH_LOW_LATENCY_INTERVAL_MS = 45000;
const float BLE_SCAN_UNIT_TIME = 0.625;

/// Invalid MAC Address
const std::string BLE_INVALID_MAC_ADDRESS = "00:00:00:00:00:00";
const std::string BLE_DEFAULT_DEVICE_NAME = "BluetoothDevice";
const uint8_t BLE_DEFAULT_IO = 0x01;
const std::string BLE_DEFAULT_LOCAL_PASSKEY = "0x12346";
const uint8_t BLE_DEFAULT_ROLES = 0x0F;
const uint8_t BLE_DEFAULT_MODEL1_LEVEL = 0x00;
const uint8_t BLE_DEFAULT_MODEL2_LEVEL = 0x00;
const bool BLE_DEFAULT_SECURITY = false;
const uint8_t BLE_DEFAULT_SCAN_MODE = 0x03;

const uint8_t BLE_NON_RES_PRI_ADDR = 0x3F;
const uint8_t BLE_STATIC_PRI_ADDR = 0xC0;

const int BTM_ACL_DISCONNECT_REASON = 0x13;
const int BLE_THREAD_WAIT_TIMEOUT = 5;
