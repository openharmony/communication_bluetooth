...
public:
     ...
     * @brief Semaphore val reduce 1.
     *        If val after reduce operation is less than 0,
     *        block waiting until timeout, or other call Post() to increase Semaphore val greater or equal to 0.
     *
     * @return Success reduce Semaphore val return true, return false if timeout.
     * @since 6
     */
    bool WaitForMs(uint32_t timeout);
