...
static constexpr char PRODUCT_BT_BDADDR_PATH[]  = "/mnt/vendor/btmac.txt";
...
class BluetoothAddress {
 public:
  ...
  static bool generate_local_address(uint8_t* local_addr, char* file_name);

  static bool write_local_address(char* addr_str, char* file_name);
};
