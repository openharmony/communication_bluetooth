...
const BtAddr agBtAddr = { { 1, 0, 0, 0, 0, 0}, 1};
const std::string agAddr = "00:00:00:00:00:01";
...
public:
    ...
    MOCK_METHOD0(BTM_RegisterCallbacks, int());
    MOCK_METHOD0(BTM_DeregisterCallbacks, int());
...
void registerBtmMocker(AgBtmMock *mocker);
AgBtmMock& GetBtmMocker();
...
void registerSdpMocker(AgSdpMock *mocker);
AgSdpMock& GetSdpMocker();
#endif // AG_MOCK_H