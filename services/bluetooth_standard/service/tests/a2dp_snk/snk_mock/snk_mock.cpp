...
BtAddr btAddr;
typedef void (*ServiceSearchAttributeCbT)(const BtAddr *, const SdpService *, uint16_t, void *);
typedef void (*ServiceSearchCbT)(const BtAddr *, const uint32_t *, uint16_t, void *);
ServiceSearchAttributeCbT ServiceSearchAttributeCb;
int SDP_ServiceSearchAttribute(const BtAddr *addr, const SdpUuid *uuidArray, SdpAttributeIdList attributeIdList,
    void *context, ServiceSearchAttributeCbT callback)
{
