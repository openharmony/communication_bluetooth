...
public:
    ...
    /**
     * @brief Reload XML Dodument from specified path.
    ...
    /**
     * @brief Whether XML document has specified addr.
     *
     * @param section
     * @return true XML document has specified addr.
     * @return false XML document doesnot have specified addr.
     * @since 1.0
     * @version 1.0
     */
    virtual bool HasAddr(const std::string &addr) = 0;
    ...
    /**
     * @brief Get sepecified addr's all sections.
     *
     * @param section
     * @param addrs
     * @return true Specitied section has one or Mutiple addresses.
     * @return false Specitied section donot has any address.
     * @since 1.0
     * @version 1.0
     */
    virtual bool GetSections(const std::string &addr, std::vector<std::string> &sections) = 0;
};
...
public:
     ...
     * @version 1.0
     */
    virtual bool HasAddr(const std::string &addr) override;
     ...
     * @version 1.0
     */
    virtual bool GetSections(const std::string &addr, std::vector<std::string> &sections) override;
