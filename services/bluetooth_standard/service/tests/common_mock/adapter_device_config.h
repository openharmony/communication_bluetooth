...
public:
    ...
    /**
     * @brief Load XML Dodument from specified path.
     ...
     * @return true Specitied section has one or Mutiple subSections.
     * @return false Specitied section donot has any subSection.
     */
...
private:
    ...
    std::mutex mutex_{};
    static AdapterDeviceConfig *instance_;
    DECLARE_IMPL();
};
}  // namespace bluetooth
