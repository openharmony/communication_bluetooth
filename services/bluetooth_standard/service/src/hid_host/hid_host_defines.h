...
namespace bluetooth {
enum HID_HOST_STATE {
    HID_HOST_STATE_DISCONNECTED = 0,
    HID_HOST_STATE_CONNECTING,
    HID_HOST_STATE_DISCONNECTING,
    HID_HOST_STATE_CONNECTED
};

enum HID_HOST_RESULT { HID_HOST_SUCCESS, HID_HOST_FAILURE };

enum HID_HOST_EVT {
    HID_HOST_INVALID_EVT = 0,

    // service start/stop
    HID_HOST_SERVICE_STARTUP_EVT,
    HID_HOST_SERVICE_SHUTDOWN_EVT,

    HID_HOST_API_OPEN_EVT,
    HID_HOST_API_CLOSE_EVT,
    HID_HOST_INT_OPEN_EVT,
    HID_HOST_INT_CLOSE_EVT,
    HID_HOST_INT_DATA_EVT,
    HID_HOST_INT_CTRL_DATA,
    HID_HOST_INT_HANDSK_EVT,
    HID_HOST_SDP_CMPL_EVT, // SDP completes
    HID_HOST_API_WRITE_DEV_EVT, // Write device action. can be SET/GET/DATA transaction.
    HID_HOST_API_GET_DSCP_EVT, // Get device report descriptor
    HID_HOST_OPEN_CMPL_EVT,

    HID_HOST_REMOVE_STATE_MACHINE_EVT,
    HID_HOST_CONNECTION_TIMEOUT_EVT,
    HID_HOST_DISCONNECTION_TIMEOUT_EVT,

    HID_HOST_L2CAP_START_EVT = 100,
    HID_HOST_L2CAP_CONNECT_REQ_EVT,
    HID_HOST_L2CAP_CONNECT_RSP_EVT,
    HID_HOST_L2CAP_CONFIG_REQ_EVT,
    HID_HOST_L2CAP_CONFIG_RSP_EVT,
    HID_HOST_L2CAP_DISCONNECT_REQ_EVT,
    HID_HOST_L2CAP_DISCONNECT_RSP_EVT,
    HID_HOST_L2CAP_DISCONNECT_ABNORMAL_EVT,
    HID_HOST_L2CAP_DATA_EVT,
    HID_HOST_L2CAP_REMOTE_BUSY_EVT,
    HID_HOST_L2CAP_SECURITY_RESULT_EVT,
    HID_HOST_L2CAP_IND_SECURITY_RESULT_EVT,
    HID_HOST_L2CAP_END_EVT,
};

enum HID_HOST_CONN_STATE {
    HID_HOST_CONN_STATE_UNUSED,
    HID_HOST_CONN_STATE_CONNECTING_CTRL,
    HID_HOST_CONN_STATE_CONNECTING_INTR,
    HID_HOST_CONN_STATE_CONFIG,
    HID_HOST_CONN_STATE_CONNECTED,
    HID_HOST_CONN_STATE_DISCONNECTING,
    HID_HOST_CONN_STATE_SECURITY,
};

enum HID_HOST_REPORT {
    HID_HOST_INPUT_REPORT = 1,
    HID_HOST_OUTPUT_REPORT,
    HID_HOST_FEATURE_REPORT
};

enum HidHostRoleType {
    HID_HOST_INITIATOR,
    HID_HOST_ACCEPTOR,
};
