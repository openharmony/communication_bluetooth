...
namespace bluetooth {
int HfpAgGapClient::RegisterServiceSecurity(const BtAddr &address, uint8_t scn)
{
    ...
    securityInfo_.serviceId = HFP_AG;
...
int HfpAgGapClient::DeregisterServiceSecurity(const BtAddr &address) const
{
