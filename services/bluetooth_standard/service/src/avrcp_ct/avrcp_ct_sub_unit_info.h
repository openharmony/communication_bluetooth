...
#ifndef AVRCP_CT_SUB_UNIT_INFO_H
#define AVRCP_CT_SUB_UNIT_INFO_H
 ...
 */
using AvrcCtSubUnit = enum {
    AVRC_CT_SUB_UNIT_COMMAND_SIZE = 0x0008,     // The size of the command frame.
    AVRC_CT_SUB_UNIT_RESPONSE_SIZE = 0x0008,    // The size of the response frame.
    AVRC_CT_SUB_UNIT_SUBUNIT_TYPE_UNIT = 0x1F,  // The value of the "Subunit_type".
    AVRC_CT_SUB_UNIT_SUBUNIT_ID_IGNORE = 0x07,  // The value of the "Subunit_ID".
    AVRC_CT_SUB_UNIT_PAGE = 0x00,               // The value of the "Page".
    AVRC_CT_SUB_UNIT_EXTENTION_CODE = 0x07,     // The value of the "Extention_code".
    AVRC_CT_SUB_UNIT_OCTET_4 = 0xFF,            // The fixed value and no name.
};

/**
 * @brief This enumeration declares the values of the moving bit
 */
enum AvrcCtSubUnitMoveBit {
    AVRC_CT_SUB_UNIT_MOVE_BIT_3 = 0x03,
    AVRC_CT_SUB_UNIT_MOVE_BIT_4 = 0x04,
};
 ...
 */
class AvrcCtSubUnitPacket : public AvrcCtUnitPacket {
public:
    /**
     * @brief A constructor used to create an <b>AvrcCtSubUnitPacket</b> instance.
     */
    AvrcCtSubUnitPacket();
     ...
     */
    explicit AvrcCtSubUnitPacket(Packet *pkt);

    /**
     * @brief A destructor used to delete the <b>AvrcCtSubUnitPacket</b> instance.
     */
    ~AvrcCtSubUnitPacket(void);
...
private:
    uint8_t page_ {AVRC_CT_SUB_UNIT_PAGE};                     // The value of the "Page".
    uint8_t extentionCode_ {AVRC_CT_SUB_UNIT_EXTENTION_CODE};  // The value of the "Extention_code".

    DISALLOW_COPY_AND_ASSIGN(AvrcCtSubUnitPacket);
};
}  // namespace bluetooth
