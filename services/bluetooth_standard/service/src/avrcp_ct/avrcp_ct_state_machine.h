...
enum AvrcCtSmEvent {
    // Invalid message.
    AVRC_CT_SM_EVENT_INVALID = 0x00,
    // Transits to the "CONNECTED" state.
    AVRC_CT_SM_EVENT_TO_CONNECTED_STATE,
    // Transits to the "DISCONNECTING" state.
    AVRC_CT_SM_EVENT_TO_DISCONNECTING_STATE,
    // Transits to the "DISABLE" state.
    AVRC_CT_SM_EVENT_TO_DISABLE_STATE,
    // Send the command of the <b>PASS THROUGH</b>.
    AVRC_CT_SM_EVENT_PASS_THROUGH,
    // Send the command of the <b>UNIT INFO"</b>.
    AVRC_CT_SM_EVENT_UNIT_INFO,
    // Send the command of the <b>SUB UNIT INFO</b>.
    AVRC_CT_SM_EVENT_SUB_UNIT_INFO,
    // Send the command of the <b>GetCapabilities"</b>.
    AVRC_CT_SM_EVENT_GET_CAPABILITIES = AVRC_CT_PDU_ID_GET_CAPABILITIES,
    // Send the command of the <b>ListPlayerApplicationSettingAttributes"</b>.
    AVRC_CT_SM_EVENT_LIST_PLAYER_APPLICATION_SETTING_ATTRIBUTES,
    // Send the command of the <b>ListPlayerApplicationSettingValues"</b>.
    AVRC_CT_SM_EVENT_LIST_PLAYER_APPLICATION_SETTING_VALUES = AVRC_CT_PDU_ID_LIST_PLAYER_APPLICATION_SETTING_VALUES,
    // Send the command of the <b>GetCurrentPlayerApplicationSettingValue"</b>.
    AVRC_CT_SM_EVENT_GET_CURRENT_PLAYER_APPLICATION_SETTING_VALUE =
        AVRC_CT_PDU_ID_GET_CURRENT_PLAYER_APPLICATION_SETTING_VALUE,
    // Send the command of the <b>SetPlayerApplicationSettingValue"</b>.
    AVRC_CT_SM_EVENT_SET_PLAYER_APPLICATION_SETTING_VALUE = AVRC_CT_PDU_ID_SET_PLAYER_APPLICATION_SETTING_VALUE,
    // Send the command of the <b>GetPlayerApplicationSettingAttributeText"</b>.
    AVRC_CT_SM_EVENT_GET_PLAYER_APPLICATION_SETTING_ATTRIBUTE_TEXT =
        AVRC_CT_PDU_ID_GET_PLAYER_APPLICATION_SETTING_ATTRIBUTE_TEXT,
    // Send the command of the <b>GetPlayerApplicationSettingValueText"</b>.
    AVRC_CT_SM_EVENT_GET_PLAYER_APPLICATION_SETTING_VALUE_TEXT =
        AVRC_CT_PDU_ID_GET_PLAYER_APPLICATION_SETTING_VALUE_TEXT,
    // Send the command of the <b>GetElementAttributes"</b>.
    AVRC_CT_SM_EVENT_GET_ELEMENT_ATTRIBUTES = AVRC_CT_PDU_ID_GET_ELEMENT_ATTRIBUTES,
    // Send the command of the <b>GetPlayStatus"</b>.
    AVRC_CT_SM_EVENT_GET_PLAY_STATUS = AVRC_CT_PDU_ID_GET_PLAY_STATUS,
    // Send the command of the <b>RequestContinuingResponse"</b>.
    AVRC_CT_SM_EVENT_REQUEST_CONTINUING_RESPONSE = AVRC_CT_PDU_ID_REQUEST_CONTINUING_RESPONSE,
    // Send the command of the <b>AbortContinuingResponse"</b>.
    AVRC_CT_SM_EVENT_ABORT_CONTINUING_RESPONSE = AVRC_CT_PDU_ID_ABORT_CONTINUING_RESPONSE,
    // Send the command of the <b>SetAddressedPlayer"</b>.
    AVRC_CT_SM_EVENT_SET_ADDRESSED_PLAYER = AVRC_CT_PDU_ID_SET_ADDRESSED_PLAYER,
    // Send the command of the <b>SetBrowsedPlayer"</b>.
    AVRC_CT_SM_EVENT_SET_BROWSED_PLAYER = AVRC_CT_PDU_ID_SET_BROWSED_PLAYER,
    // Send the command of the <b>ChangePath"</b>.
    AVRC_CT_SM_EVENT_CHANGE_PATH = AVRC_CT_PDU_ID_CHANGE_PATH,
    // Send the command of the <b>GetFolderItems"</b>.
    AVRC_CT_SM_EVENT_GET_FOLDER_ITEMS = AVRC_CT_PDU_ID_GET_FOLDER_ITEMS,
    // Send the command of the <b>GetItemAttributes"</b>.
    AVRC_CT_SM_EVENT_GET_ITEM_ATTRIBUTES = AVRC_CT_PDU_ID_GET_ITEM_ATTRIBUTES,
    // Send the command of the <b>GetTotalNumberOfItems"</b>.
    AVRC_CT_SM_EVENT_GET_TOTAL_NUMBER_OF_ITEMS = AVRC_CT_PDU_ID_GET_TOTAL_NUMBER_OF_ITEMS,
    // Send the command of the <b>PlayItem"</b>.
    AVRC_CT_SM_EVENT_PLAY_ITEM = AVRC_CT_PDU_ID_PLAY_ITEM,
    // Send the command of the <b>AddToNowPlaying"</b>.
    AVRC_CT_SM_EVENT_ADD_TO_NOW_PLAYING = AVRC_CT_PDU_ID_ADD_TO_NOW_PLAYING,
    // Send the command of the <b>SetAbsoluteVolume"</b>.
    AVRC_CT_SM_EVENT_SET_ABSOLUTE_VOLUME = AVRC_CT_PDU_ID_SET_ABSOLUTE_VOLUME,
    // Send the command of the <b>RegisterNotification"</b>.
    AVRC_CT_SM_EVENT_REGISTER_NOTIFICATION = AVRC_CT_PDU_ID_REGISTER_NOTIFICATION,
};
 ...
 *                              CONNECTED
 *                   /           /     \        \                \
 *       DISCONNECTING     PENDING     BUSY     CONTINUATION     DISABLE
 ...
 * 5. BUSY              X             O              O             X        -
 */
class AvrcCtStateMachineManager {
public:
    /**
     * @brief A destructor used to delete the <b>AvrcCtStateMachineManager</b> instance.
     */
    ~AvrcCtStateMachineManager();

    /**
     * @brief Gets the instance of the <b>AvrcCtStateMachineManager</b> class.
     *
     * @return The instance of the AvrcCtStateMachineManager.
     */
    static AvrcCtStateMachineManager *GetInstance(void);
    ...
    /**
     * @brief Checks the current state is "PENDING" or not.
     *
     * @param[in] rawAddr The address of the bluetooth device.
     * @return The result of the method execution.
     * @retval true  Current state is "PENDING".
     * @retval false Current state is not "PENDING".
     */
    bool IsControlPendingState(const RawAddress &rawAddr);
     ...
     * @retval false Current state is not "PENDING".
     */
    bool IsBrowsePendingState(const RawAddress &rawAddr);
...
private:
    ...
    public:
         ...
         */
        enum class Type {
            AVRC_CT_SM_TYPE_CONTROL,  // The control state machine.
            AVRC_CT_SM_TYPE_BROWSE,   // The browse state machine.
        };
    ...
    private:
        ...
        public:
            explicit State(const std::string &name, utility::StateMachine &sm, const RawAddress &rawAddr);
            explicit State(const std::string &name, utility::StateMachine &sm, const RawAddress &rawAddr,
        ...
        public:
             ...
             */
            CtConnecting(const std::string &name, utility::StateMachine &sm, const RawAddress &rawAddr);
        ...
        public:
             ...
             */
            CtConnected(const std::string &name, utility::StateMachine &sm, const RawAddress &rawAddr,
                utility::StateMachine::State &parent);
        ...
        public:
             ...
             */
            CtDisconnecting(const std::string &name, utility::StateMachine &sm, const RawAddress &rawAddr,
                utility::StateMachine::State &parent);
        ...
        public:
             ...
             */
            CtContinuation(const std::string &name, utility::StateMachine &sm, const RawAddress &rawAddr,
                utility::StateMachine::State &parent);
        ...
        public:
             ...
             */
            CtDisable(const std::string &name, utility::StateMachine &sm, const RawAddress &rawAddr,
                utility::StateMachine::State &parent);
        ...
        /**
         * @brief This class provides a set of methods for entry/exit the "PENDING" state of the control state
         * machine and processing messages that are sent to the state.
         */
        class CtPending : public State {
        public:
            /**
             * @brief A constructor used to create an <b>CtPending</b> instance.
             */
            CtPending(const std::string &name, utility::StateMachine &sm, const RawAddress &rawAddr,
                utility::StateMachine::State &parent);
        ...
        public:
             ...
             */
            BrConnecting(const std::string &name, utility::StateMachine &sm, const RawAddress &rawAddr);
        ...
        public:
             ...
             */
            BrConnected(const std::string &name, utility::StateMachine &sm, const RawAddress &rawAddr,
                utility::StateMachine::State &parent);
        ...
        public:
             ...
             */
            BrDisconnecting(const std::string &name, utility::StateMachine &sm, const RawAddress &rawAddr,
                utility::StateMachine::State &parent);
        ...
        /**
         * @brief This class provides a set of methods for entry/exit the "PENDING" state of the browse state
         * machine and processing messages that are sent to the state.
         */
        class BrPending : public State {
        public:
            /**
             * @brief A constructor used to create an <b>BrPending</b> instance.
             */
            BrPending(const std::string &name, utility::StateMachine &sm, const RawAddress &rawAddr,
                utility::StateMachine::State &parent);
    ...
    /**
     * @brief A constructor used to create an <b>AvrcCtStateMachineManager</b> instance.
     */
    AvrcCtStateMachineManager();
    ...
    /**
     * @brief Checks the current state is specified state.
     *
     * @param[in] rawAddr   The address of the bluetooth device.
     * @param[in] stateName The name of the specified state.
     * @return The result of the method execution.
     * @retval true  Current state is the specified state.
     * @retval false Current state is not the specified state.
     */
