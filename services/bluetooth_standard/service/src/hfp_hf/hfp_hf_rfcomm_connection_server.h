...
#ifndef HFP_HF_RFCOMM_CONNECTION_SERVER_H
#define HFP_HF_RFCOMM_CONNECTION_SERVER_H
 ...
 */
class HfpHfRfcommConnectionServer {
public:
    /**
     * @brief Construct a new HfpHfRfcommConnectionServer object.
     */
    HfpHfRfcommConnectionServer() = default;

    /**
     * @brief Destroy the HfpHfRfcommConnectionServer object.
     */
    ~HfpHfRfcommConnectionServer() = default;
...
private:
    ...
    DISALLOW_COPY_AND_ASSIGN(HfpHfRfcommConnectionServer);
};
}  // namespace bluetooth
