...
{   HILOGD("%{public}s start.", __func__);
    ...
    memberFuncMap_[static_cast<uint32_t>(
        BluetoothGattServerCallbackStub::Code::GATT_SERVER_ON_ADD_SERVICE)] =
    ...
    memberFuncMap_[static_cast<uint32_t>(
        BluetoothGattServerCallbackStub::Code::GATT_SERVER_ON_MTU_CHANGED)] =
        &BluetoothGattServerCallbackStub::OnMtuChangedInner;
    memberFuncMap_[static_cast<uint32_t>(
        BluetoothGattServerCallbackStub::Code::GATT_SERVER_ON_NOTIFY_CONFIRM)] =
...
int BluetoothGattServerCallbackStub::OnRemoteRequest(uint32_t code, MessageParcel &data, MessageParcel &reply,
