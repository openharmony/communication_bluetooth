...
bool ParcelBtUuid::WriteToParcel(MessageParcel &parcel, bluetooth::Uuid &uuid)
{
    ...
    uint64_t most_sig_bits = 
        ((((uint64_t)uuid128[0]) << 56) | (((uint64_t)uuid128[1]) << 48) |
         (((uint64_t)uuid128[2]) << 40) | (((uint64_t)uuid128[3]) << 32) |
         (((uint64_t)uuid128[4]) << 24) | (((uint64_t)uuid128[5]) << 16) |
         (((uint64_t)uuid128[6]) << 8) | uuid128[7]);

    uint64_t least_sig_bits = 
        ((((uint64_t)uuid128[8]) << 56) | (((uint64_t)uuid128[9]) << 48) |
         (((uint64_t)uuid128[10]) << 40) | (((uint64_t)uuid128[11]) << 32) |
         (((uint64_t)uuid128[12]) << 24) | (((uint64_t)uuid128[13]) << 16) |
