...
static void ConvertScanReportMode(ScanOptions &params, int32_t scanReportMode)
{
    switch (scanReportMode) {
        case static_cast<int32_t>(ScanReportMode::NORMAL):
            ...
            break;
        case static_cast<int32_t>(ScanReportMode::BATCH):
            params.reportMode = ScanReportMode::BATCH;
            break;
    ...
    BleScanSettings &outSettinngs)
{
    ...
    if (argc == ARGS_SIZE_TWO) {
        ...
        settings.SetEnhanceMode(static_cast<int32_t>(scanOptions.scanEnhanceMode.mode), scanOptions.scanEnhanceMode.timeout);
