 ...
 */
#ifndef LOG_TAG
#define LOG_TAG "bt_napi_a2dp_snk_observer"
#endif
...
namespace OHOS {
namespace Bluetooth {
NapiA2dpSinkObserver::NapiA2dpSinkObserver()
    : eventSubscribe_(STR_BT_A2DP_SINK_CONNECTION_STATE_CHANGE, BT_MODULE_NAME)
{}
