...
#ifndef LOG_TAG
#define LOG_TAG "bt_taihe_a2dp_snk_observer"
#endif
...
TaiheA2dpSinkObserver::TaiheA2dpSinkObserver()
{}

void TaiheA2dpSinkObserver::OnConnectionStateChanged(const BluetoothRemoteDevice &device, int state, int cause)
{
