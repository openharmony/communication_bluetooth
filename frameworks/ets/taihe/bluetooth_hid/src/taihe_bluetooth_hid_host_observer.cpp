...
TaiheBluetoothHidHostObserver::TaiheBluetoothHidHostObserver()
{}

void TaiheBluetoothHidHostObserver::OnConnectionStateChanged(const BluetoothRemoteDevice &device,
    int state, int cause)
{
