...
#ifndef BLUETOOTH_SWITCH_MODULE_H
#define BLUETOOTH_SWITCH_MODULE_H
...
public:
    ...
    virtual int EnableBluetoothToHalfAppRegisteredMode(std::string) = 0;
};
...
enum class BluetoothSwitchEvent : int {
    ...
    ENABLE_BLUETOOTH_TO_HALF_APP_REGISTERED,
    BLUETOOTH_ON,
    BLUETOOTH_OFF,
    BLUETOOTH_HALF,
    BLUETOOTH_HALF_APP_REGISTERED,
};
...
private:
    ...
    int ProcessEnableBluetoothToHalfAppRegisteredModeEvent(const std::string &callingName);
    int ProcessBluetoothOnEvent(void);
    int ProcessBluetoothOffEvent(void);
    int ProcessBluetoothHalfEvent(void);
    int ProcessBluetoothHalfAppRegisteredEvent(void);
...
#endif  // BLUETOOTH_SWITCH_MODULE_H
