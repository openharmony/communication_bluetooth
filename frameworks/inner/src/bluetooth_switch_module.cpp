...
static const char *ToString(BluetoothSwitchEvent event)
{
    switch (event) {
        ...
        case BluetoothSwitchEvent::ENABLE_BLUETOOTH_TO_BLE_OWNER_ONLY: return "ENABLE_BLUETOOTH_TO_BLE_OWNER_ONLY";
        ...
        case BluetoothSwitchEvent::BLUETOOTH_BLE_OWNER_ONLY: return "BLUETOOTH_BLE_OWNER_ONLY";
        default: break;
    }
    return "Unknown";
}
...
void BluetoothSwitchModule::LogBluetoothSwitchEvent(BluetoothSwitchEvent event)
{
    bool needLog = (event == BluetoothSwitchEvent::BLUETOOTH_ON ||
        ...
        event == BluetoothSwitchEvent::BLUETOOTH_BLE_OWNER_ONLY) ? isBtSwitchProcessing_.load() : true;
    if (needLog) {
    ...
    BluetoothSwitchEvent event, std::string callingName, bool isAsync)
{
    ...
    switch (event) {
        ...
        case BluetoothSwitchEvent::ENABLE_BLUETOOTH_TO_BLE_OWNER_ONLY:
            return ProcessEnableBluetoothToBleOwnerOnlyEvent(callingName);
        ...
        case BluetoothSwitchEvent::BLUETOOTH_BLE_OWNER_ONLY:
            return ProcessBluetoothBleOwnerOnlyEvent();
        default: break;
    }
...
int BluetoothSwitchModule::ProcessEnableBluetoothToBleOwnerOnlyEvent(const std::string &callingName)
{
    BluetoothSwitchCacheEvent cachedEvent = {
        .event = BluetoothSwitchEvent::ENABLE_BLUETOOTH_TO_BLE_OWNER_ONLY,
        .callingName = callingName,
    };

    return ProcessBluetoothSwitchAction(
        [this, callingName]() { return switchAction_->EnableBluetoothToBleOwnerOnlyMode(callingName); },
        cachedEvent);
}
...
int BluetoothSwitchModule::ProcessBluetoothBleOwnerOnlyEvent(void)
{
    return ProcessBluetoothSwitchActionEnd(
        BluetoothSwitchEvent::ENABLE_BLUETOOTH_TO_BLE_OWNER_ONLY,
