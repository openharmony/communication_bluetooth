...
enum BluetoothBleAdvertiserInterfaceCode {
    ...
    BLE_GET_ADVPOWER_FOR_RANGING,
    BLE_RESTORE_RANGING_ANT_SWITCH,
    // The last code, if you want to add a new code, please add it before this
    BLE_ADVERTISER_BUTT
};
...
enum BluetoothHidDeviceObserverInterfaceCode {
    COMMAND_ON_CONNECTION_STATE_CHANGED = MIN_TRANSACTION_ID + 0,
    COMMAND_ON_APP_STATUS_CHANGED,
    COMMAND_ON_GET_REPORT,
    COMMAND_ON_INTERRUPT_DATA,
    COMMAND_ON_SET_PROTOCOL,
    COMMAND_ON_SET_REPORT,
    COMMAND_ON_VIRTUAL_CABLE_UNPLUG,
    // The last code, if you want to add a new code, please add it before this
    COMMAND_HID_DEVICE_OBSERVER_BUTT
};

enum class BluetoothHidDeviceInterfaceCode {
    COMMAND_REGISTER_APP = MIN_TRANSACTION_ID + 0,
    COMMAND_UNREGISTER_APP,
    COMMAND_CONNECT,
    COMMAND_DISCONNECT,
    COMMAND_GET_CONNECTION_STATE,
    COMMAND_GET_CONNECTED_DEVICES,
    COMMAND_REGISTER_OBSERVER,
    COMMAND_DEREGISTER_OBSERVER,
    COMMAND_SEND_REPORT,
    COMMAND_REPLY_REPORT,
    COMMAND_REPORT_ERROR,
    COMMAND_SET_CONNECT_STRATEGY,
    COMMAND_GET_CONNECT_STRATEGY,
    // The last code, if you want to add a new code, please add it before this
    COMMAND_HID_DEVICE_BUTT
};
...
enum BluetoothHostInterfaceCode {
    ...
    SET_BT_CHANNEL_SCAN,
    BT_ENABLE_BLUETOOTH_TO_BLE_OWNER_ONLY_MODE,
    // The last code, if you want to add a new code, please add it before this
    BT_HOST_BUTT
};
