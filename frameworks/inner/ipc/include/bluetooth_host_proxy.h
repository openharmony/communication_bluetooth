...
public:
    ...
    int32_t StartRemoteSdpSearch(const std::string &address, const std::string &uuid, bool &status) override;
    int32_t GetRemoteServices(const std::string &address, bool &status) override;
private:
