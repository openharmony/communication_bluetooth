...
private:
    ...
    ErrCode OnPermissionInner(MessageParcel &data, MessageParcel &reply);

    using BluetoothHostFunc = ErrCode (BluetoothMapMseObserverStub::*)(MessageParcel &data, MessageParcel &reply);
