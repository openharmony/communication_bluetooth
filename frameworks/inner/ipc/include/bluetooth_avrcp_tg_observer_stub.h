...
#ifndef OHOS_BLUETOOTH_STANDARD_AVRCP_TG_OBSERVER_STUB_H
#define OHOS_BLUETOOTH_STANDARD_AVRCP_TG_OBSERVER_STUB_H
...
namespace OHOS {
namespace Bluetooth {
class BluetoothAvrcpTgObserverStub : public IRemoteStub<IBluetoothAvrcpTgObserver> {
public:
...
#endif  // OHOS_BLUETOOTH_STANDARD_AVRCP_TG_OBSERVER_STUB_H