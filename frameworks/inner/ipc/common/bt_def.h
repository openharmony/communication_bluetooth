...
constexpr const char *BLUETOOTH_UUID_HID_HOST = "00001124-0000-1000-8000-00805F9B34FB";
constexpr const char *BLUETOOTH_UUID_PAN = "00001116-0000-1000-8000-00805F9B34FB";
constexpr const char *BLUETOOTH_UUID_OPP = "00001105-0000-1000-8000-00805F9B34FB";
constexpr const char *BLUETOOTH_UUID_HSP_AG = "00001112-0000-1000-8000-00805F9B34FB";
...
enum GattStatus {
    ...
    SERVICE_STARTED = -48,
    INVALID_CFG = -47,
    REMOTE_DEVICE_PENDING = -46,
    CMD_STARTED = -45,
    REMOTE_DEVICE_ERROR = -44,
    DB_FULL = -43,
    WRONG_STATE = -42,
    NO_RESOURCES = -41,
    TOO_SHORT = -40,
    VALUE_NOT_ALLOWED = -39,
    DATABASE_OUT_OF_SYNC = -38,
    INSUF_RESOURCE = -37,
    UNSUPPORT_GRP_TYPE = -36,
    ERR_UNLIKELY = -35,
    INVALID_PDU = -34,
...
constexpr uint16_t BLE_SCAN_MODE_OP_P10_25_250_WINDOW_MS = 25;
constexpr uint16_t BLE_SCAN_MODE_OP_P10_25_250_INTERVAL_MS = 250;
...
constexpr int8_t BLE_LPDEVICE_MSG_CAPABILITY_QUERY = 0x13;
constexpr int8_t BLE_LPDEVICE_MSG_SCAN_COLLABORATION_QUERY = 0x14;
constexpr int8_t BLE_LPDEVICE_MSG_SCAN_COLLABORATION_RESULT = 0x15;
constexpr int8_t BLE_LPDEVICE_MSG_GATT_CONN_COLLABORATION_QUERY = 0x16;
constexpr int8_t BLE_LPDEVICE_MSG_GATT_CONN_COLLABORATION_RESULT = 0x17;
constexpr int8_t BLE_LPDEVICE_MSG_SET_BLE_BUFFER_SIZE_AND_NUM = 0x18;

// collaboration msg from lpdevice
constexpr uint8_t BLE_LPDEVICE_MSG_CAPABILITY = 0x01;
constexpr uint8_t BLE_LPDEVICE_MSG_SCAN_COLLABORATION_NOTIFY_STATUS = 0x02;
constexpr uint8_t BLE_LPDEVICE_MSG_GATT_CONN_COLLABORATION_NOTIFY_STATUS = 0x03;
...
enum A2dpUserCodecPriority : uint32_t {
    ...
    A2DP_CODEC_PRIORITY_L2HCST_USER = 8000,
...
enum BluetoothSensingEventId : uint8_t {
    INVALID_SENSING_EVENT = 0x00,
    SPP_CLIENT_CONNECT_DONE = 0x01,
    SPP_SERVER_CONNECT_DONE = 0x02,
    SPP_PORT_CLOSE = 0x03,
    SPP_SERVER_CLOSE = 0x04,
    SPP_SERVER_LISTEN_DONE = 0x05,
    GATT_SERVER_REGISTER_DONE = 0x10,
    GATT_SERVER_UNREGISTER_DONE = 0x11,
    GATT_CLIENT_CONNECT_DONE = 0x012,
    GATT_CLIENT_CONNECT_CLOSE = 0x13,
    GATT_SERVER_CONNECT_DONE = 0x14,
    GATT_SERVER_CONNECT_CLOSE = 0x15,
    SOCKET_REGISTER_APPLICATION_PKGNAME = 0x20,
    GATT_REGISTER_APPLICATION_PKGNAME = 0x21,
    BLE_CONN_INTERVAL_UPDATE = 0X30,
    BLE_ADV_STARTED = 0X40,
...
enum BluetoothDecisionEventId : uint8_t {
    INVALID_DECISION_EVENT = 0x00,
    BLE_FASTEST_CONN_DECISION = 0x01,
};

enum BluetoothResourceDecisionResult {
    CONNECTION_REJECT = 0x00,
    CONNECTION_ACCEPT,
...
enum BluetoothSwitchState {
    ...
    STATE_OFF,
    STATE_HALF,
    STATE_HALF_APP_REGISTERED,  // half + registered owner: both stacks are on, BLE available only to the owner app
};
...
enum BluetoothTransferredSwitchAction {
    ...
    TRANS_ACTION_ENABLE_BLUETOOTH_TO_HALF_APP_REGISTERED,
};
