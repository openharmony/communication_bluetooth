...
/***/ "../../../../../gitee/commbluetooth/test/example/BluetoothTest-bak/entry/src/main/ets/MainAbility/pages/subAutoTest/sppAutoTest.ets?entry":
/*!************************************************************************************************************************************************!*\
  !*** ../../../../../gitee/commbluetooth/test/example/BluetoothTest-bak/entry/src/main/ets/MainAbility/pages/subAutoTest/sppAutoTest.ets?entry ***!
  \************************************************************************************************************************************************/
...
__webpack_require__(/*! ../../../Utils/ConfigData */ "../../../../../gitee/commbluetooth/test/example/BluetoothTest-bak/entry/src/main/ets/Utils/ConfigData.ts");
...
class SppAutoTest extends View {
    ...
    render() {
        Column.create();
        Column.debugLine("pages/subAutoTest/sppAutoTest.ets(36:5)");
        ...
        Stack.debugLine("pages/subAutoTest/sppAutoTest.ets(37:7)");
        ...
        Stack.pop();
        List.create();
        List.debugLine("pages/subAutoTest/sppAutoTest.ets(41:7)");
        List.height('93%');
        ...
        ForEach.create("5", this, ObservedObject.GetRawObject(this.sppAutoTestItems), item => {
            ListItem.create();
            ListItem.debugLine("pages/subAutoTest/sppAutoTest.ets(43:11)");
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["commons"], () => (__webpack_require__("../../../../../gitee/commbluetooth/test/example/BluetoothTest-bak/entry/src/main/ets/MainAbility/pages/subAutoTest/sppAutoTest.ets?entry")))
