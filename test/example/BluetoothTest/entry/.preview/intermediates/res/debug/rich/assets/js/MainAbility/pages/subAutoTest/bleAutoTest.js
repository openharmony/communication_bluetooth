...
/***/ "../../../../../gitee/commbluetooth/test/example/BluetoothTest-bak/entry/src/main/ets/MainAbility/pages/subAutoTest/bleAutoTest.ets?entry":
/*!************************************************************************************************************************************************!*\
  !*** ../../../../../gitee/commbluetooth/test/example/BluetoothTest-bak/entry/src/main/ets/MainAbility/pages/subAutoTest/bleAutoTest.ets?entry ***!
  \************************************************************************************************************************************************/
...
__webpack_require__(/*! @ohos.bluetooth */ "../../api/@ohos.bluetooth.d.ts");
const BLEInterface = __importStar(__webpack_require__(/*! ../../model/bleInterface */ "../../../../../gitee/commbluetooth/test/example/BluetoothTest-bak/entry/src/main/ets/MainAbility/model/bleInterface.ets"));
...
class BleAutoTest extends View {
    ...
    render() {
        Column.create();
        Column.debugLine("pages/subAutoTest/bleAutoTest.ets(40:5)");
        Stack.create({ alignContent: Alignment.TopStart });
        Stack.debugLine("pages/subAutoTest/bleAutoTest.ets(41:7)");
        ...
        Stack.pop();
        Stack.create();
        Stack.debugLine("pages/subAutoTest/bleAutoTest.ets(45:7)");
        Stack.height("1vp");
        Stack.backgroundColor("#000000");
        Stack.pop();
        Column.create();
        Column.debugLine("pages/subAutoTest/bleAutoTest.ets(46:7)");
        Column.height(520);
        Column.width("100%");
        Column.backgroundColor({ "id": 125829132, "type": 10001, params: [] });
        Scroll.create();
        Scroll.debugLine("pages/subAutoTest/bleAutoTest.ets(47:9)");
        Scroll.scrollBarWidth(10);
        Scroll.scrollBar(BarState.Auto);
        Column.create();
        Column.debugLine("pages/subAutoTest/bleAutoTest.ets(48:11)");
        Column.width("100%");
        Column.height(260);
        Text.create("API验证:");
        Text.debugLine("pages/subAutoTest/bleAutoTest.ets(49:13)");
        Text.fontSize("17vp");
        ...
        if (earlierCreatedChild_4 == undefined) {
            View.create(new autoContentTable_1.AutoContentTable("4", this, { testItem: this.testItem, autoItems: autoTestDataModels_1.initBleAutoData() }));
        }
        else {
            earlierCreatedChild_4.updateWithValueParams({
                testItem: this.testItem, autoItems: autoTestDataModels_1.initBleAutoData()
            });
        ...
        Scroll.pop();
        Stack.create();
        Stack.debugLine("pages/subAutoTest/bleAutoTest.ets(240:9)");
        Stack.height("1vp");
        Stack.backgroundColor("#000000");
        Stack.pop();
        Scroll.create();
        Scroll.debugLine("pages/subAutoTest/bleAutoTest.ets(242:9)");
        Scroll.scrollBarWidth(10);
        Scroll.scrollBar(BarState.Auto);
        Column.create();
        Column.debugLine("pages/subAutoTest/bleAutoTest.ets(243:11)");
        Column.width("100%");
        Column.height(260);
        Text.create("Debug日志:");
        Text.debugLine("pages/subAutoTest/bleAutoTest.ets(244:13)");
        Text.fontSize("17vp");
        Text.margin({ top: "8vp", bottom: "8vp", left: "10vp", right: "258vp" });
        Text.textAlign(TextAlign.Start);
        Text.pop();
        List.create();
        List.debugLine("pages/subAutoTest/bleAutoTest.ets(248:13)");
        List.height("80%");
        ListItem.create();
        ListItem.debugLine("pages/subAutoTest/bleAutoTest.ets(249:15)");
        Text.create("log:" + "\n" + this.autoTestMessage);
        Text.debugLine("pages/subAutoTest/bleAutoTest.ets(250:17)");
        Text.fontSize("17vp");
        ...
        Column.pop();
        Stack.create();
        Stack.debugLine("pages/subAutoTest/bleAutoTest.ets(270:7)");
        Stack.height("1vp");
        Stack.backgroundColor("#000000");
        Stack.pop();
        Column.create();
        Column.debugLine("pages/subAutoTest/bleAutoTest.ets(271:7)");
        Column.backgroundColor({ "id": 125829132, "type": 10001, params: [] });
        Column.width(ConfigData_1.default.WH_100_100);
        Column.height(ConfigData_1.default.WH_100_100);
        Button.createWithChild({ type: ButtonType.Normal, stateEffect: true });
        Button.debugLine("pages/subAutoTest/bleAutoTest.ets(272:9)");
        ...
        Button.onClick((event) => {
            ...
            let autoTestMessage = "";
            let message = "";
            autoTestMessage += BLEInterface.testCreateGattClientDevice() + "\n"; //创建Gatt服务器
            autoTestMessage += BLEInterface.testCreateGattServerDevice() + "\n"; //创建Gatt客户端
            autoTestMessage += BLEInterface.testGetConnectedBLEDevices() + "\n"; //获取连接的BLE设备
            autoTestMessage += BLEInterface.testStartBLEScan() + "\n"; //开始BLE扫描
            autoTestMessage += BLEInterface.testStopBLEScan() + "\n"; //停止BLE扫描
            autoTestMessage += BLEInterface.testOnBLEDeviceFind() + "\n"; //注册BLE查找状态变化
            message = "测试完成";
            console.log(message);
        ...
        Row.create();
        Row.debugLine("pages/subAutoTest/bleAutoTest.ets(273:11)");
        Row.alignItems(VerticalAlign.Center);
        Text.create('自动测试');
        Text.debugLine("pages/subAutoTest/bleAutoTest.ets(274:13)");
        Text.fontSize("24vp");
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["commons"], () => (__webpack_require__("../../../../../gitee/commbluetooth/test/example/BluetoothTest-bak/entry/src/main/ets/MainAbility/pages/subAutoTest/bleAutoTest.ets?entry")))
