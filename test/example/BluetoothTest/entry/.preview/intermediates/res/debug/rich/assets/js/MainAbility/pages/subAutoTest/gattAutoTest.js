...
/***/ "../../../../../gitee/commbluetooth/test/example/BluetoothTest-bak/entry/src/main/ets/MainAbility/pages/subAutoTest/gattAutoTest.ets?entry":
/*!*************************************************************************************************************************************************!*\
  !*** ../../../../../gitee/commbluetooth/test/example/BluetoothTest-bak/entry/src/main/ets/MainAbility/pages/subAutoTest/gattAutoTest.ets?entry ***!
  \*************************************************************************************************************************************************/
...
class GattAutoTest extends View {
    ...
    render() {
        Column.create();
        Column.debugLine("pages/subAutoTest/gattAutoTest.ets(36:5)");
        ...
        Stack.debugLine("pages/subAutoTest/gattAutoTest.ets(37:7)");
        ...
        Stack.pop();
        List.create();
        List.debugLine("pages/subAutoTest/gattAutoTest.ets(41:7)");
        List.height('93%');
        ...
        ForEach.create("5", this, ObservedObject.GetRawObject(this.gattAutoTestItems), item => {
            ListItem.create();
            ListItem.debugLine("pages/subAutoTest/gattAutoTest.ets(43:11)");
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["commons"], () => (__webpack_require__("../../../../../gitee/commbluetooth/test/example/BluetoothTest-bak/entry/src/main/ets/MainAbility/pages/subAutoTest/gattAutoTest.ets?entry")))
