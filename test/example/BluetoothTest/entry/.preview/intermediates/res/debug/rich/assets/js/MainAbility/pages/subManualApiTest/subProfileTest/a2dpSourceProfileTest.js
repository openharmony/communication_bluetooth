...
/***/ "../../../../../gitee/commbluetooth/test/example/BluetoothTest-bak/entry/src/main/ets/MainAbility/pages/subManualApiTest/subProfileTest/a2dpSourceProfileTest.ets?entry":
/*!******************************************************************************************************************************************************************************!*\
  !*** ../../../../../gitee/commbluetooth/test/example/BluetoothTest-bak/entry/src/main/ets/MainAbility/pages/subManualApiTest/subProfileTest/a2dpSourceProfileTest.ets?entry ***!
  \******************************************************************************************************************************************************************************/
...
class Index extends View {
    constructor(compilerAssignedUniqueChildId, parent, params) {
        ...
        this.__title = new ObservedPropertyObject({ "id": 16777219, "type": 10003, params: [] }, this, "title");
    ...
    render() {
        Row.create();
        Row.debugLine("pages/subManualApiTest/subProfileTest/a2dpSourceProfileTest.ets(51:5)");
        Row.backgroundColor({ "id": 125829132, "type": 10001, params: [] });
        Row.height('100%');
        Row.alignItems(VerticalAlign.Top);
        Column.create();
        Column.debugLine("pages/subManualApiTest/subProfileTest/a2dpSourceProfileTest.ets(52:7)");
        Column.width('100%');
        let earlierCreatedChild_2 = this.findChildById("2");
        if (earlierCreatedChild_2 == undefined) {
            View.create(new pageTitle_1.PageTitle("2", this, { detail: 'A2dpSource测试' }));
        }
        else {
        ...
        Stack.create();
        Stack.debugLine("pages/subManualApiTest/subProfileTest/a2dpSourceProfileTest.ets(54:9)");
        Stack.height("0.5vp");
        Stack.backgroundColor("#000000");
        Stack.pop();
        Text.create(this.hasProfile ? this.profileExist : this.profileNotExist);
        Text.debugLine("pages/subManualApiTest/subProfileTest/a2dpSourceProfileTest.ets(55:9)");
        ...
        Text.pop();
        Column.create();
        Column.debugLine("pages/subManualApiTest/subProfileTest/a2dpSourceProfileTest.ets(62:9)");
        Column.visibility(this.hasProfile ? Visibility.Visible : Visibility.Hidden);
        Row.create();
        Row.debugLine("pages/subManualApiTest/subProfileTest/a2dpSourceProfileTest.ets(63:11)");
        ...
        Text.debugLine("pages/subManualApiTest/subProfileTest/a2dpSourceProfileTest.ets(64:13)");
        Text.fontSize("17");
        Text.width(110);
        Text.pop();
        TextInput.create({ text: JSON.stringify(this.deviceId), placeholder: "请输入需要连接的deviceId" });
        TextInput.debugLine("pages/subManualApiTest/subProfileTest/a2dpSourceProfileTest.ets(66:13)");
        ...
        Row.pop();
        Column.create();
        Column.debugLine("pages/subManualApiTest/subProfileTest/a2dpSourceProfileTest.ets(78:11)");
        Column.backgroundColor({ "id": 125829123, "type": 10001, params: [] });
        Column.width("88%");
        Text.create("接口调用结果： " + this.message);
        Text.debugLine("pages/subManualApiTest/subProfileTest/a2dpSourceProfileTest.ets(79:13)");
        Text.fontSize("17vp");
        Text.textAlign(TextAlign.Start);
        Text.pop();
        Text.create("connectionStateChange： " + this.connectionStateInfo);
        Text.debugLine("pages/subManualApiTest/subProfileTest/a2dpSourceProfileTest.ets(82:13)");
        Text.fontSize("17vp");
        ...
        Text.debugLine("pages/subManualApiTest/subProfileTest/a2dpSourceProfileTest.ets(90:11)");
        ...
        Text.pop();
        Scroll.create();
        Scroll.debugLine("pages/subManualApiTest/subProfileTest/a2dpSourceProfileTest.ets(95:11)");
        Scroll.height("70%");
        ...
        if (earlierCreatedChild_3 == undefined) {
            View.create(new contentTable_1.ContentTable("3", this, { apiItems: testDataModels_1.initA2dpSourceProfileApiData() }));
        }
        else {
...
/******/ 		var installedChunks = {
/******/ 			"./pages/subManualApiTest/subProfileTest/a2dpSourceProfileTest": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["commons"], () => (__webpack_require__("../../../../../gitee/commbluetooth/test/example/BluetoothTest-bak/entry/src/main/ets/MainAbility/pages/subManualApiTest/subProfileTest/a2dpSourceProfileTest.ets?entry")))
