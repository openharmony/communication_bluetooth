...
/***/ "../../../../../gitee/commbluetooth/test/example/BluetoothTest-bak/entry/src/main/ets/MainAbility/pages/subManualApiTest/subProfileTest/handsFreeAudioGatewayProfileTest.ets?entry":
/*!*****************************************************************************************************************************************************************************************!*\
  !*** ../../../../../gitee/commbluetooth/test/example/BluetoothTest-bak/entry/src/main/ets/MainAbility/pages/subManualApiTest/subProfileTest/handsFreeAudioGatewayProfileTest.ets?entry ***!
  \*****************************************************************************************************************************************************************************************/
...
class Index extends View {
    constructor(compilerAssignedUniqueChildId, parent, params) {
        ...
        this.__title = new ObservedPropertyObject({ "id": 16777261, "type": 10003, params: [] }, this, "title");
    ...
    render() {
        Row.create();
        Row.debugLine("pages/subManualApiTest/subProfileTest/handsFreeAudioGatewayProfileTest.ets(48:5)");
        Row.backgroundColor({ "id": 125829132, "type": 10001, params: [] });
        Row.height('100%');
        Row.alignItems(VerticalAlign.Top);
        Column.create();
        Column.debugLine("pages/subManualApiTest/subProfileTest/handsFreeAudioGatewayProfileTest.ets(49:7)");
        Column.width('100%');
        let earlierCreatedChild_2 = this.findChildById("2");
        if (earlierCreatedChild_2 == undefined) {
            View.create(new pageTitle_1.PageTitle("2", this, { detail: 'HandsFreeAudioGateway测试' }));
        }
        else {
            earlierCreatedChild_2.updateWithValueParams({
                detail: 'HandsFreeAudioGateway测试'
            });
        ...
        Stack.create();
        Stack.debugLine("pages/subManualApiTest/subProfileTest/handsFreeAudioGatewayProfileTest.ets(51:9)");
        Stack.height("0.5vp");
        Stack.backgroundColor("#000000");
        Stack.pop();
        Text.create(this.hasProfile ? this.profileExist : this.profileNotExist);
        Text.debugLine("pages/subManualApiTest/subProfileTest/handsFreeAudioGatewayProfileTest.ets(52:9)");
        ...
        Text.pop();
        Column.create();
        Column.debugLine("pages/subManualApiTest/subProfileTest/handsFreeAudioGatewayProfileTest.ets(59:9)");
        Column.visibility(this.hasProfile ? Visibility.Visible : Visibility.Hidden);
        Row.create();
        Row.debugLine("pages/subManualApiTest/subProfileTest/handsFreeAudioGatewayProfileTest.ets(60:11)");
        ...
        Text.debugLine("pages/subManualApiTest/subProfileTest/handsFreeAudioGatewayProfileTest.ets(61:13)");
        Text.fontSize("17");
        Text.width(110);
        Text.pop();
        TextInput.create({ text: JSON.stringify(this.deviceId), placeholder: "请输入需要连接的deviceId" });
        TextInput.debugLine("pages/subManualApiTest/subProfileTest/handsFreeAudioGatewayProfileTest.ets(63:13)");
        ...
        Row.pop();
        Column.create();
        Column.debugLine("pages/subManualApiTest/subProfileTest/handsFreeAudioGatewayProfileTest.ets(75:11)");
        Column.backgroundColor({ "id": 125829123, "type": 10001, params: [] });
        Column.width("88%");
        Text.create("接口调用结果： " + this.message);
        Text.debugLine("pages/subManualApiTest/subProfileTest/handsFreeAudioGatewayProfileTest.ets(76:13)");
        Text.fontSize("17vp");
        Text.textAlign(TextAlign.Start);
        Text.pop();
        Text.create("connectionStateChange： " + this.connectionStateInfo);
        Text.debugLine("pages/subManualApiTest/subProfileTest/handsFreeAudioGatewayProfileTest.ets(79:13)");
        Text.fontSize("17vp");
        ...
        Text.debugLine("pages/subManualApiTest/subProfileTest/handsFreeAudioGatewayProfileTest.ets(87:11)");
        ...
        Text.pop();
        Scroll.create();
        Scroll.debugLine("pages/subManualApiTest/subProfileTest/handsFreeAudioGatewayProfileTest.ets(92:11)");
        Scroll.height("70%");
        ...
        if (earlierCreatedChild_3 == undefined) {
            View.create(new contentTable_1.ContentTable("3", this, { apiItems: testDataModels_1.initHandsFreeAudioGatewayProfileApiData() }));
        }
        else {
...
/******/ 		var installedChunks = {
/******/ 			"./pages/subManualApiTest/subProfileTest/handsFreeAudioGatewayProfileTest": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["commons"], () => (__webpack_require__("../../../../../gitee/commbluetooth/test/example/BluetoothTest-bak/entry/src/main/ets/MainAbility/pages/subManualApiTest/subProfileTest/handsFreeAudioGatewayProfileTest.ets?entry")))
