...
/***/ "../../../../../gitee/commbluetooth/test/example/BluetoothTest-bak/entry/src/main/ets/MainAbility/pages/subAutoTest/subSppAutoTest/sppClientAutoTest.ets?entry":
/*!*********************************************************************************************************************************************************************!*\
  !*** ../../../../../gitee/commbluetooth/test/example/BluetoothTest-bak/entry/src/main/ets/MainAbility/pages/subAutoTest/subSppAutoTest/sppClientAutoTest.ets?entry ***!
  \*********************************************************************************************************************************************************************/
...
const SppClientInterface = __importStar(__webpack_require__(/*! ../../../model/sppClientInterface */ "../../../../../gitee/commbluetooth/test/example/BluetoothTest-bak/entry/src/main/ets/MainAbility/model/sppClientInterface.ets"));
...
class SppClientAutoTest extends View {
    ...
    render() {
        Column.create();
        Column.debugLine("pages/subAutoTest/subSppAutoTest/sppClientAutoTest.ets(40:5)");
        Stack.create({ alignContent: Alignment.TopStart });
        Stack.debugLine("pages/subAutoTest/subSppAutoTest/sppClientAutoTest.ets(41:7)");
        ...
        Stack.pop();
        Stack.create();
        Stack.debugLine("pages/subAutoTest/subSppAutoTest/sppClientAutoTest.ets(45:7)");
        Stack.height("1vp");
        Stack.backgroundColor("#000000");
        Stack.pop();
        Column.create();
        Column.debugLine("pages/subAutoTest/subSppAutoTest/sppClientAutoTest.ets(46:7)");
        Column.height(520);
        Column.width("100%");
        Column.backgroundColor({ "id": 125829132, "type": 10001, params: [] });
        Scroll.create();
        Scroll.debugLine("pages/subAutoTest/subSppAutoTest/sppClientAutoTest.ets(47:9)");
        Scroll.scrollBarWidth(10);
        Scroll.scrollBar(BarState.Auto);
        Column.create();
        Column.debugLine("pages/subAutoTest/subSppAutoTest/sppClientAutoTest.ets(48:11)");
        Column.width("100%");
        Column.height(260);
        Text.create("API验证:");
        Text.debugLine("pages/subAutoTest/subSppAutoTest/sppClientAutoTest.ets(49:13)");
        Text.fontSize("17vp");
        ...
        if (earlierCreatedChild_4 == undefined) {
            View.create(new autoContentTable_1.AutoContentTable("4", this, { testItem: this.testItem, autoItems: autoTestDataModels_1.initSppClientAutoData() }));
        }
        else {
            earlierCreatedChild_4.updateWithValueParams({
                testItem: this.testItem, autoItems: autoTestDataModels_1.initSppClientAutoData()
            });
        ...
        Scroll.pop();
        Stack.create();
        Stack.debugLine("pages/subAutoTest/subSppAutoTest/sppClientAutoTest.ets(61:9)");
        Stack.height("1vp");
        Stack.backgroundColor("#000000");
        Stack.pop();
        Scroll.create();
        Scroll.debugLine("pages/subAutoTest/subSppAutoTest/sppClientAutoTest.ets(63:9)");
        Scroll.scrollBarWidth(10);
        Scroll.scrollBar(BarState.Auto);
        Column.create();
        Column.debugLine("pages/subAutoTest/subSppAutoTest/sppClientAutoTest.ets(64:11)");
        Column.width("100%");
        Column.height(260);
        Text.create("Debug日志:");
        Text.debugLine("pages/subAutoTest/subSppAutoTest/sppClientAutoTest.ets(65:13)");
        Text.fontSize("17vp");
        Text.margin({ top: "8vp", bottom: "8vp", left: "10vp", right: "258vp" });
        Text.textAlign(TextAlign.Start);
        Text.pop();
        List.create();
        List.debugLine("pages/subAutoTest/subSppAutoTest/sppClientAutoTest.ets(69:13)");
        List.height("80%");
        ListItem.create();
        ListItem.debugLine("pages/subAutoTest/subSppAutoTest/sppClientAutoTest.ets(70:15)");
        Text.create("log:" + "\n" + this.autoTestMessage);
        Text.debugLine("pages/subAutoTest/subSppAutoTest/sppClientAutoTest.ets(71:17)");
        Text.fontSize("17vp");
        ...
        Column.pop();
        Stack.create();
        Stack.debugLine("pages/subAutoTest/subSppAutoTest/sppClientAutoTest.ets(91:7)");
        Stack.height("1vp");
        Stack.backgroundColor("#000000");
        Stack.pop();
        Column.create();
        Column.debugLine("pages/subAutoTest/subSppAutoTest/sppClientAutoTest.ets(92:7)");
        Column.backgroundColor({ "id": 125829132, "type": 10001, params: [] });
        Column.width(ConfigData_1.default.WH_100_100);
        Column.height(ConfigData_1.default.WH_100_100);
        Button.createWithChild({ type: ButtonType.Normal, stateEffect: true });
        Button.debugLine("pages/subAutoTest/subSppAutoTest/sppClientAutoTest.ets(93:9)");
        ...
        Button.onClick((event) => {
            ...
            autoTestMessage += SppClientInterface.testSetSppBluetoothScanMode() + "\n"; // 设置spp扫描模式
            ...
            autoTestMessage += SppClientInterface.testSppClientConnectSafe() + "\n"; //spp客户端连接（安全模式）
            autoTestMessage += SppClientInterface.testSppClientConnectUnSafe() + "\n"; //spp客户端连接（非安全模式）
            autoTestMessage += BrInterface.testPairDevice() + "\n"; //配对设备
            autoTestMessage += SppClientInterface.testSppClientWrite() + "\n"; //spp客户端写入
            autoTestMessage += SppClientInterface.testSppClientReadOn() + "\n"; //spp客户端读取打开
            autoTestMessage += SppClientInterface.testSppClientReadOff() + "\n"; //spp客户端读取关闭
            autoTestMessage += SppClientInterface.testSppClientClose() + "\n"; //spp客户端关闭
        ...
        Row.create();
        Row.debugLine("pages/subAutoTest/subSppAutoTest/sppClientAutoTest.ets(94:11)");
        Row.alignItems(VerticalAlign.Center);
        Text.create('自动测试');
        Text.debugLine("pages/subAutoTest/subSppAutoTest/sppClientAutoTest.ets(95:13)");
        Text.fontSize("24vp");
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["commons"], () => (__webpack_require__("../../../../../gitee/commbluetooth/test/example/BluetoothTest-bak/entry/src/main/ets/MainAbility/pages/subAutoTest/subSppAutoTest/sppClientAutoTest.ets?entry")))
