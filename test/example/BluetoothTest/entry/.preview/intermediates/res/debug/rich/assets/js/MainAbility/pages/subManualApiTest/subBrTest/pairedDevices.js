...
/***/ "../../../../../gitee/commbluetooth/test/example/BluetoothTest-bak/entry/src/main/ets/MainAbility/pages/subManualApiTest/subBrTest/pairedDevices.ets?entry":
/*!*****************************************************************************************************************************************************************!*\
  !*** ../../../../../gitee/commbluetooth/test/example/BluetoothTest-bak/entry/src/main/ets/MainAbility/pages/subManualApiTest/subBrTest/pairedDevices.ets?entry ***!
  \*****************************************************************************************************************************************************************/
...
class pairedDevices extends View {
    ...
    render() {
        Column.create();
        Column.debugLine("pages/subManualApiTest/subBrTest/pairedDevices.ets(35:5)");
        ...
        GridContainer.debugLine("pages/subManualApiTest/subBrTest/pairedDevices.ets(36:7)");
        GridContainer.width(ConfigData_1.default.WH_100_100);
        GridContainer.height(ConfigData_1.default.WH_100_100);
        Row.create({});
        Row.debugLine("pages/subManualApiTest/subBrTest/pairedDevices.ets(37:9)");
        Row.width(ConfigData_1.default.WH_100_100);
        Row.height(ConfigData_1.default.WH_100_100);
        Column.create();
        Column.debugLine("pages/subManualApiTest/subBrTest/pairedDevices.ets(38:11)");
        Column.width(ConfigData_1.default.WH_100_100);
        Column.height(ConfigData_1.default.WH_100_100);
        Column.useSizeType({
        ...
        Column.pop();
        Column.create();
        Column.debugLine("pages/subManualApiTest/subBrTest/pairedDevices.ets(47:11)");
        ...
        Divider.create();
        Divider.debugLine("pages/subManualApiTest/subBrTest/pairedDevices.ets(51:13)");
        Divider.padding({ left: { "id": 125829735, "type": 10002, params: [] }, right: { "id": 125829736, "type": 10002, params: [] } });
        Column.create();
        Column.debugLine("pages/subManualApiTest/subBrTest/pairedDevices.ets(54:13)");
        List.create();
        List.debugLine("pages/subManualApiTest/subBrTest/pairedDevices.ets(55:15)");
        ForEach.create("4", this, ObservedObject.GetRawObject(this.pairedDevices), (item) => {
            ListItem.create();
            ListItem.debugLine("pages/subManualApiTest/subBrTest/pairedDevices.ets(57:19)");
        ...
        List.pop();
        Blank.create();
        Blank.debugLine("pages/subManualApiTest/subBrTest/pairedDevices.ets(62:15)");
        Blank.pop();
        Column.pop();
        Flex.create({ direction: FlexDirection.Row, justifyContent: FlexAlign.Center, alignItems: ItemAlign.Center });
        Flex.debugLine("pages/subManualApiTest/subBrTest/pairedDevices.ets(65:13)");
        Row.create();
        Row.debugLine("pages/subManualApiTest/subBrTest/pairedDevices.ets(66:15)");
        ...
        if (earlierCreatedChild_5 == undefined) {
            View.create(new ButtonComponent("5", this, { text: { "id": 16777253, "type": 10003, params: [] }, onClick: () => {
        ...
        Row.pop();
        Row.create();
        Row.debugLine("pages/subManualApiTest/subBrTest/pairedDevices.ets(73:15)");
        Row.width({ "id": 16777355, "type": 10002, params: [] });
        let earlierCreatedChild_6 = this.findChildById("6");
        if (earlierCreatedChild_6 == undefined) {
            View.create(new ButtonComponent("6", this, { text: { "id": 16777256, "type": 10003, params: [] }, onClick: () => {
                    _system_router_1.back();
                } }));
        }
        else {
...
class ButtonComponent extends View {
    ...
    render() {
        Column.create();
        Column.debugLine("pages/subManualApiTest/subBrTest/pairedDevices.ets(108:5)");
        Column.width(ConfigData_1.default.WH_100_100);
        Column.align(Alignment.Center);
        Text.create(this.text);
        Text.debugLine("pages/subManualApiTest/subBrTest/pairedDevices.ets(109:7)");
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["commons"], () => (__webpack_require__("../../../../../gitee/commbluetooth/test/example/BluetoothTest-bak/entry/src/main/ets/MainAbility/pages/subManualApiTest/subBrTest/pairedDevices.ets?entry")))
