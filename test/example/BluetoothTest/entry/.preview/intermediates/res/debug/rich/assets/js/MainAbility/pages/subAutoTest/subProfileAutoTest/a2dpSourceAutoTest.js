...
/***/ "../../../../../gitee/commbluetooth/test/example/BluetoothTest-bak/entry/src/main/ets/MainAbility/pages/subAutoTest/subProfileAutoTest/a2dpSourceAutoTest.ets?entry":
/*!**************************************************************************************************************************************************************************!*\
  !*** ../../../../../gitee/commbluetooth/test/example/BluetoothTest-bak/entry/src/main/ets/MainAbility/pages/subAutoTest/subProfileAutoTest/a2dpSourceAutoTest.ets?entry ***!
  \**************************************************************************************************************************************************************************/
...
class A2dpSourceAutoTest extends View {
    ...
    render() {
        Column.create();
        Column.debugLine("pages/subAutoTest/subProfileAutoTest/a2dpSourceAutoTest.ets(39:5)");
        Stack.create({ alignContent: Alignment.TopStart });
        Stack.debugLine("pages/subAutoTest/subProfileAutoTest/a2dpSourceAutoTest.ets(40:7)");
        ...
        Stack.pop();
        Stack.create();
        Stack.debugLine("pages/subAutoTest/subProfileAutoTest/a2dpSourceAutoTest.ets(44:7)");
        Stack.height("1vp");
        Stack.backgroundColor("#000000");
        Stack.pop();
        Column.create();
        Column.debugLine("pages/subAutoTest/subProfileAutoTest/a2dpSourceAutoTest.ets(45:7)");
        Column.height(520);
        Column.width("100%");
        Column.backgroundColor({ "id": 125829132, "type": 10001, params: [] });
        Scroll.create();
        Scroll.debugLine("pages/subAutoTest/subProfileAutoTest/a2dpSourceAutoTest.ets(46:9)");
        Scroll.scrollBarWidth(10);
        Scroll.scrollBar(BarState.Auto);
        Column.create();
        Column.debugLine("pages/subAutoTest/subProfileAutoTest/a2dpSourceAutoTest.ets(47:11)");
        Column.width("100%");
        Column.height(260);
        Text.create("API验证:");
        Text.debugLine("pages/subAutoTest/subProfileAutoTest/a2dpSourceAutoTest.ets(48:13)");
        Text.fontSize("17vp");
        ...
        if (earlierCreatedChild_4 == undefined) {
            View.create(new autoContentTable_1.AutoContentTable("4", this, { testItem: this.testItem, autoItems: autoTestDataModels_1.initA2dpSourceProfileAutoData() }));
        }
        else {
            earlierCreatedChild_4.updateWithValueParams({
                testItem: this.testItem, autoItems: autoTestDataModels_1.initA2dpSourceProfileAutoData()
            });
        ...
        Scroll.pop();
        Stack.create();
        Stack.debugLine("pages/subAutoTest/subProfileAutoTest/a2dpSourceAutoTest.ets(210:9)");
        Stack.height("1vp");
        Stack.backgroundColor("#000000");
        Stack.pop();
        Scroll.create();
        Scroll.debugLine("pages/subAutoTest/subProfileAutoTest/a2dpSourceAutoTest.ets(212:9)");
        Scroll.scrollBarWidth(10);
        Scroll.scrollBar(BarState.Auto);
        Column.create();
        Column.debugLine("pages/subAutoTest/subProfileAutoTest/a2dpSourceAutoTest.ets(213:11)");
        Column.width("100%");
        Column.height(260);
        Text.create("Debug日志:");
        Text.debugLine("pages/subAutoTest/subProfileAutoTest/a2dpSourceAutoTest.ets(214:13)");
        Text.fontSize("17vp");
        Text.margin({ top: "8vp", bottom: "8vp", left: "10vp", right: "258vp" });
        Text.textAlign(TextAlign.Start);
        Text.pop();
        List.create();
        List.debugLine("pages/subAutoTest/subProfileAutoTest/a2dpSourceAutoTest.ets(218:13)");
        List.height("80%");
        ListItem.create();
        ListItem.debugLine("pages/subAutoTest/subProfileAutoTest/a2dpSourceAutoTest.ets(219:15)");
        Text.create("log:" + "\n" + this.autoTestMessage);
        Text.debugLine("pages/subAutoTest/subProfileAutoTest/a2dpSourceAutoTest.ets(220:17)");
        Text.fontSize("17vp");
        ...
        Column.pop();
        Stack.create();
        Stack.debugLine("pages/subAutoTest/subProfileAutoTest/a2dpSourceAutoTest.ets(240:7)");
        Stack.height("1vp");
        Stack.backgroundColor("#000000");
        Stack.pop();
        Column.create();
        Column.debugLine("pages/subAutoTest/subProfileAutoTest/a2dpSourceAutoTest.ets(241:7)");
        Column.backgroundColor({ "id": 125829132, "type": 10001, params: [] });
        Column.width(ConfigData_1.default.WH_100_100);
        Column.height(ConfigData_1.default.WH_100_100);
        Button.createWithChild({ type: ButtonType.Normal, stateEffect: true });
        Button.debugLine("pages/subAutoTest/subProfileAutoTest/a2dpSourceAutoTest.ets(242:9)");
        ...
        Row.create();
        Row.debugLine("pages/subAutoTest/subProfileAutoTest/a2dpSourceAutoTest.ets(243:11)");
        Row.alignItems(VerticalAlign.Center);
        Text.create('自动测试');
        Text.debugLine("pages/subAutoTest/subProfileAutoTest/a2dpSourceAutoTest.ets(244:13)");
        Text.fontSize("24vp");
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["commons"], () => (__webpack_require__("../../../../../gitee/commbluetooth/test/example/BluetoothTest-bak/entry/src/main/ets/MainAbility/pages/subAutoTest/subProfileAutoTest/a2dpSourceAutoTest.ets?entry")))
