...
/***/ "../../../../../gitee/commbluetooth/test/example/BluetoothTest-bak/entry/src/main/ets/MainAbility/pages/subAutoTest/subProfileAutoTest/hitHostAutoTest.ets?entry":
/*!***********************************************************************************************************************************************************************!*\
  !*** ../../../../../gitee/commbluetooth/test/example/BluetoothTest-bak/entry/src/main/ets/MainAbility/pages/subAutoTest/subProfileAutoTest/hitHostAutoTest.ets?entry ***!
  \***********************************************************************************************************************************************************************/
...
class HitHostAutoTest extends View {
    ...
    render() {
        Column.create();
        Column.debugLine("pages/subAutoTest/subProfileAutoTest/hitHostAutoTest.ets(39:5)");
        Stack.create({ alignContent: Alignment.TopStart });
        Stack.debugLine("pages/subAutoTest/subProfileAutoTest/hitHostAutoTest.ets(40:7)");
        ...
        Stack.pop();
        Stack.create();
        Stack.debugLine("pages/subAutoTest/subProfileAutoTest/hitHostAutoTest.ets(44:7)");
        Stack.height("1vp");
        Stack.backgroundColor("#000000");
        Stack.pop();
        Column.create();
        Column.debugLine("pages/subAutoTest/subProfileAutoTest/hitHostAutoTest.ets(45:7)");
        Column.height(520);
        Column.width("100%");
        Column.backgroundColor({ "id": 125829132, "type": 10001, params: [] });
        Scroll.create();
        Scroll.debugLine("pages/subAutoTest/subProfileAutoTest/hitHostAutoTest.ets(46:9)");
        Scroll.scrollBarWidth(10);
        Scroll.scrollBar(BarState.Auto);
        Column.create();
        Column.debugLine("pages/subAutoTest/subProfileAutoTest/hitHostAutoTest.ets(47:11)");
        Column.width("100%");
        Column.height(260);
        Text.create("API验证:");
        Text.debugLine("pages/subAutoTest/subProfileAutoTest/hitHostAutoTest.ets(48:13)");
        Text.fontSize("17vp");
        ...
        if (earlierCreatedChild_4 == undefined) {
            View.create(new autoContentTable_1.AutoContentTable("4", this, { testItem: this.testItem, autoItems: autoTestDataModels_1.initHitHostProfileAutoData() }));
        }
        else {
            earlierCreatedChild_4.updateWithValueParams({
                testItem: this.testItem, autoItems: autoTestDataModels_1.initHitHostProfileAutoData()
            });
        ...
        Scroll.pop();
        Stack.create();
        Stack.debugLine("pages/subAutoTest/subProfileAutoTest/hitHostAutoTest.ets(181:9)");
        Stack.height("1vp");
        Stack.backgroundColor("#000000");
        Stack.pop();
        Scroll.create();
        Scroll.debugLine("pages/subAutoTest/subProfileAutoTest/hitHostAutoTest.ets(183:9)");
        Scroll.scrollBarWidth(10);
        Scroll.scrollBar(BarState.Auto);
        Column.create();
        Column.debugLine("pages/subAutoTest/subProfileAutoTest/hitHostAutoTest.ets(184:11)");
        Column.width("100%");
        Column.height(260);
        Text.create("Debug日志:");
        Text.debugLine("pages/subAutoTest/subProfileAutoTest/hitHostAutoTest.ets(185:13)");
        Text.fontSize("17vp");
        Text.margin({ top: "8vp", bottom: "8vp", left: "10vp", right: "258vp" });
        Text.textAlign(TextAlign.Start);
        Text.pop();
        List.create();
        List.debugLine("pages/subAutoTest/subProfileAutoTest/hitHostAutoTest.ets(189:13)");
        List.height("80%");
        ListItem.create();
        ListItem.debugLine("pages/subAutoTest/subProfileAutoTest/hitHostAutoTest.ets(190:15)");
        Text.create("log:" + "\n" + this.autoTestMessage);
        Text.debugLine("pages/subAutoTest/subProfileAutoTest/hitHostAutoTest.ets(191:17)");
        Text.fontSize("17vp");
        ...
        Column.pop();
        Stack.create();
        Stack.debugLine("pages/subAutoTest/subProfileAutoTest/hitHostAutoTest.ets(211:7)");
        Stack.height("1vp");
        Stack.backgroundColor("#000000");
        Stack.pop();
        Column.create();
        Column.debugLine("pages/subAutoTest/subProfileAutoTest/hitHostAutoTest.ets(212:7)");
        Column.backgroundColor({ "id": 125829132, "type": 10001, params: [] });
        Column.width(ConfigData_1.default.WH_100_100);
        Column.height(ConfigData_1.default.WH_100_100);
        Button.createWithChild({ type: ButtonType.Normal, stateEffect: true });
        Button.debugLine("pages/subAutoTest/subProfileAutoTest/hitHostAutoTest.ets(213:9)");
        ...
        Row.create();
        Row.debugLine("pages/subAutoTest/subProfileAutoTest/hitHostAutoTest.ets(214:11)");
        Row.alignItems(VerticalAlign.Center);
        Text.create('自动测试');
        Text.debugLine("pages/subAutoTest/subProfileAutoTest/hitHostAutoTest.ets(215:13)");
        Text.fontSize("24vp");
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["commons"], () => (__webpack_require__("../../../../../gitee/commbluetooth/test/example/BluetoothTest-bak/entry/src/main/ets/MainAbility/pages/subAutoTest/subProfileAutoTest/hitHostAutoTest.ets?entry")))
