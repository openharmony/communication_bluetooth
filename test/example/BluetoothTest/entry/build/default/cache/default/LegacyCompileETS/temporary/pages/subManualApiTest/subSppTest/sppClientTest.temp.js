...
/***/ "../../../../../gitee/commbluetooth/test/example/BluetoothTest/entry/src/main/ets/MainAbility/pages/subManualApiTest/subSppTest/sppClientTest.ets?entry":
/*!**************************************************************************************************************************************************************!*\
  !*** ../../../../../gitee/commbluetooth/test/example/BluetoothTest/entry/src/main/ets/MainAbility/pages/subManualApiTest/subSppTest/sppClientTest.ets?entry ***!
  \**************************************************************************************************************************************************************/
...
class SppClient extends View {
    constructor(compilerAssignedUniqueChildId, parent, params) {
        ...
        this.pairDialog = new CustomDialogController({
            builder: () => {
                let jsDialog = new PairDialog("15", this, {
    ...
    render() {
        ...
        //          HeadComponent({ headName: $r('app.string.spp_client_test_title'), isActive: true });
        Stack.create();
        //          HeadComponent({ headName: $r('app.string.spp_client_test_title'), isActive: true });
        Stack.height("0.5vp");
        //          HeadComponent({ headName: $r('app.string.spp_client_test_title'), isActive: true });
        ...
        // 客户端(安全模式)连接
        ListItem.onClick(() => {
            _ohos_bluetooth_1.sppConnect(this.deviceId, {
                uuid: this.uuid,
                secure: true,
                type: 0
            }, (code, socketID) => {
                ...
                LogUtil_1.default.info(MODEL + 'sppConnect callback socketNumber(safe mode): ' + socketID);
                this.message = "客户端连接成功!";
            });
        });
        ...
        if (earlierCreatedChild_9 == undefined) {
            View.create(new titleComponent_1.TitleComponent("9", this, {
                title: "spp_client_connect(安全模式)", fontSize: '15vp',
        ...
        ListItem.onClick(() => {
            _ohos_bluetooth_1.sppConnect(this.deviceId, {
                ...
                this.acceptClientSocket(socketID);
                LogUtil_1.default.info(MODEL + 'sppConnect callback socketNumber(non-safe mode): ' + socketID);
                this.message = "客户端连接成功!";
            });
        });
        ...
        if (earlierCreatedChild_10 == undefined) {
            View.create(new titleComponent_1.TitleComponent("10", this, {
                title: "spp_client_connect(非安全模式)", fontSize: '15vp',
        ...
        if (earlierCreatedChild_12 == undefined) {
            View.create(new titleComponent_1.TitleComponent("12", this, {
                title: "spp_client_readOn", fontSize: '15vp',
        ...
        if (earlierCreatedChild_13 == undefined) {
            View.create(new titleComponent_1.TitleComponent("13", this, {
                title: "spp_client_readOff", fontSize: '15vp',
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["commons"], () => (__webpack_require__("../../../../../gitee/commbluetooth/test/example/BluetoothTest/entry/src/main/ets/MainAbility/pages/subManualApiTest/subSppTest/sppClientTest.ets?entry")))
