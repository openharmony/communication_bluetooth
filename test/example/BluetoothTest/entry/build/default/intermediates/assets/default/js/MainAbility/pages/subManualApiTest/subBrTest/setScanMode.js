...
/***/ "../../../../../gitee/commbluetooth/test/example/BluetoothTest/entry/src/main/ets/MainAbility/pages/subManualApiTest/subBrTest/setScanMode.ets?entry":
/*!***********************************************************************************************************************************************************!*\
  !*** ../../../../../gitee/commbluetooth/test/example/BluetoothTest/entry/src/main/ets/MainAbility/pages/subManualApiTest/subBrTest/setScanMode.ets?entry ***!
  \***********************************************************************************************************************************************************/
...
class setScanMode extends View {
    ...
    render() {
        ...
        //            HeadComponent({ headName: $r('app.string.bluetooth_scan_mode_type'), isActive: true })
        //            Divider()
        //              .padding({
        ...
        if (earlierCreatedChild_3 == undefined) {
            View.create(new titleComponent_1.TitleComponent("3", this, {
                ...
                bgColor: { "id": 16777297, "type": 10001, params: [] },
                fontSize: '17vp',
            }));
        }
        else {
        ...
        Scroll.pop();
        Row.create();
        Row.padding({ "id": 16777355, "type": 10002, params: [] });
        Row.width('100%');
        ...
        TextInput.placeholderFont({
            size: { "id": 16777383, "type": 10002, params: [] },
        ...
        if (earlierCreatedChild_10 == undefined) {
            View.create(new ButtonComponent("10", this, { text: { "id": 16777250, "type": 10003, params: [] }, onClick: () => {
        ...
        if (earlierCreatedChild_11 == undefined) {
            View.create(new ButtonComponent("11", this, { text: { "id": 16777253, "type": 10003, params: [] }, onClick: () => {
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["commons"], () => (__webpack_require__("../../../../../gitee/commbluetooth/test/example/BluetoothTest/entry/src/main/ets/MainAbility/pages/subManualApiTest/subBrTest/setScanMode.ets?entry")))
