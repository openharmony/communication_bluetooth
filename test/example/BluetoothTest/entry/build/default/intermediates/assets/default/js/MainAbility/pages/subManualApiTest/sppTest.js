...
/***/ "../../../../../gitee/commbluetooth/test/example/BluetoothTest/entry/src/main/ets/MainAbility/pages/subManualApiTest/sppTest.ets?entry":
/*!*********************************************************************************************************************************************!*\
  !*** ../../../../../gitee/commbluetooth/test/example/BluetoothTest/entry/src/main/ets/MainAbility/pages/subManualApiTest/sppTest.ets?entry ***!
  \*********************************************************************************************************************************************/
...
class SppTest extends View {
    ...
    render() {
        ...
        if (earlierCreatedChild_4 == undefined) {
            View.create(new contentTable_1.ContentTable("4", this, { testItem: this.testItem, apiItems: TestDataModels_1.initSppApiData() }));
        }
        else {
            earlierCreatedChild_4.updateWithValueParams({
                testItem: this.testItem, apiItems: TestDataModels_1.initSppApiData()
            });
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["commons"], () => (__webpack_require__("../../../../../gitee/commbluetooth/test/example/BluetoothTest/entry/src/main/ets/MainAbility/pages/subManualApiTest/sppTest.ets?entry")))
