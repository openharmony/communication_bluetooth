...
/***/ "../../../../../gitee/commbluetooth/test/example/BluetoothTest/entry/src/main/ets/MainAbility/pages/manualApiTest.ets?entry":
/*!**********************************************************************************************************************************!*\
  !*** ../../../../../gitee/commbluetooth/test/example/BluetoothTest/entry/src/main/ets/MainAbility/pages/manualApiTest.ets?entry ***!
  \**********************************************************************************************************************************/
...
const subentrycomponent_1 = __webpack_require__(/*! ../../component/subentrycomponent */ "../../../../../gitee/commbluetooth/test/example/BluetoothTest/entry/src/main/ets/component/subentrycomponent.ets");
class ManualApiTest extends View {
    ...
    render() {
        ...
        if (earlierCreatedChild_2 == undefined) {
            View.create(new headcomponent_1.default("2", this, { headName: { "id": 16777220, "type": 10003, params: [] }, isActive: true }));
        }
        else {
            earlierCreatedChild_2.updateWithValueParams({
                headName: { "id": 16777220, "type": 10003, params: [] },
                isActive: true
            });
        ...
        if (earlierCreatedChild_3 == undefined) {
            View.create(new subentrycomponent_1.SubEntryComponent("3", this, { targetPage: 'pages/subManualApiTest/BrInterfaceTest', title: { "id": 16777246, "type": 10003, params: [] } }));
        }
        else {
            earlierCreatedChild_3.updateWithValueParams({
                targetPage: 'pages/subManualApiTest/BrInterfaceTest',
                title: { "id": 16777246, "type": 10003, params: [] }
            });
        ...
        if (earlierCreatedChild_4 == undefined) {
            View.create(new subentrycomponent_1.SubEntryComponent("4", this, { targetPage: "pages/subManualApiTest/bleTest", title: { "id": 16777224, "type": 10003, params: [] } }));
        }
        else {
            earlierCreatedChild_4.updateWithValueParams({
                targetPage: "pages/subManualApiTest/bleTest",
                title: { "id": 16777224, "type": 10003, params: [] }
            });
        ...
        if (earlierCreatedChild_5 == undefined) {
            View.create(new subentrycomponent_1.SubEntryComponent("5", this, { targetPage: "pages/subManualApiTest/gattTest", title: { "id": 16777257, "type": 10003, params: [] } }));
        }
        else {
            earlierCreatedChild_5.updateWithValueParams({
                targetPage: "pages/subManualApiTest/gattTest",
                title: { "id": 16777257, "type": 10003, params: [] }
            });
        ...
        if (earlierCreatedChild_6 == undefined) {
            View.create(new subentrycomponent_1.SubEntryComponent("6", this, { targetPage: "pages/subManualApiTest/sppTest", title: { "id": 16777272, "type": 10003, params: [] } }));
        }
        else {
        ...
        if (earlierCreatedChild_7 == undefined) {
            View.create(new subentrycomponent_1.SubEntryComponent("7", this, { targetPage: "pages/subManualApiTest/profileTest", title: { "id": 16777265, "type": 10003, params: [] } }));
        }
        else {
            earlierCreatedChild_7.updateWithValueParams({
                targetPage: "pages/subManualApiTest/profileTest",
                title: { "id": 16777265, "type": 10003, params: [] }
            });
...
loadDocument(new ManualApiTest("1", undefined, {}));
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["commons"], () => (__webpack_require__("../../../../../gitee/commbluetooth/test/example/BluetoothTest/entry/src/main/ets/MainAbility/pages/manualApiTest.ets?entry")))
/******/ 	__webpack_exports__ = __webpack_require__.O(__webpack_exports__);
/******/ 	_2a33209e6af7922da1521a8a828bfbd0 = __webpack_exports__;
/******/ 	
/******/ })()
;
//# sourceMappingURL=manualApiTest.js.map