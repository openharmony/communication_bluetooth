...
class TaiheBluetoothUtilsTest : public testing::Test {
public:
    TaiheBluetoothUtilsTest() = default;
    ~TaiheBluetoothUtilsTest() = default;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(TaiheBluetoothUtilsTest, IsValidAddress_001, TestSize.Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(TaiheBluetoothUtilsTest, IsValidAddress_002, TestSize.Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(TaiheBluetoothUtilsTest, IsValidAddress_003, TestSize.Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(TaiheBluetoothUtilsTest, IsValidAddress_004, TestSize.Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(TaiheBluetoothUtilsTest, IsValidAddress_005, TestSize.Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(TaiheBluetoothUtilsTest, IsValidAddress_006, TestSize.Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(TaiheBluetoothUtilsTest, IsValidAddress_007, TestSize.Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(TaiheBluetoothUtilsTest, IsValidAddress_008, TestSize.Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(TaiheBluetoothUtilsTest, IsValidAddress_009, TestSize.Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(TaiheBluetoothUtilsTest, IsValidAddress_010, TestSize.Level1)
{
