...
declare namespace bluetooth {
   ...
   */
    ...
    function getProfileConnState(profileId: number): number;
    function setDevicePariringConfirmation(device: string, accept: boolean): boolean;
    function setLocalName(name: string): boolean;
    function setBluetoothScanMode(mode: number, duration: number): boolean;
    function getBluetoothScanMode(): number;
    function startBluetoothDiscovery(): boolean;
    function stopBluetoothDiscovery(): boolean;
    function on(type: "bluetoothDeviceFind", callback: AsyncCallback<Array<string>>): void;
    function off(type: "bluetoothDeviceFind", callback?: AsyncCallback<Array<string>>): void;
    function on(type: "boneStateChange", callback: AsyncCallback<number>): void;
    function off(type: "boneStateChange", callback?: AsyncCallback<number>): void;
    function on(type: "pinRequired", callback: AsyncCallback<string>): void;
    function off(type: "pinRequired", callback?: AsyncCallback<string>): void;
    function on(type: "stateChange", callback: AsyncCallback<BluetoothState>);
    function off(type: "stateChange", callback?: AsyncCallback<BluetoothState>);
    
    function sppListen(name: string, option: SppOption, callback: AsyncCallback<serverSocket: number>): void;
    function sppAccept(serverSocket: number, callback: AsyncCallback<clientSocket: number>): void;
    function sppConnect(device: string, option: SppOption, callback: AsyncCallback<clientSocket: number>): void;
    ...
    function on(type: "sppRead", clientSocket: number, callback: AsyncCallback<ArrayBuffer>): void;
    function off(type: "sppRead", clientSocket: number, callback?: AsyncCallback<ArrayBuffer>): void;
    
    function getProfile(profileId: number): A2dpSinkProfile |
      A2dpSourceProfile | AvrcpProfile | HandsFreeAudioGatewayProfile | HandsFreeUnitProfile | HidHostProfile |
      PanNetworkProfile | PbapClientProfile | PbapServerProfile;

    interface BaseProfile {
      getConnectionDevices(): Array<string>;
      getDeviceState(device: string): number;
    }

    interface A2dpSinkProfile extends BaseProfile {
      connect(device: string): boolean;
      disconnect(device: string): boolean;
      getPlayingState(device: string): number;
      on(type: "connectionStateChange", callback: AsyncCallback<number>): void;
      off(type: "connectionStateChange", callback?: AsyncCallback<number>): void;
    }
    ...
    interface AvrcpProfile extends BaseProfile {
      on(type: "connectionStateChange", callback: AsyncCallback<number>): void;
      off(type: "connectionStateChange", callback?: AsyncCallback<number>): void;
    }
    ...
    interface HandsFreeAudioGatewayProfile extends BaseProfile {
      ...
      on(type: "connectionStateChange", callback: AsyncCallback<number>): void;
      off(type: "connectionStateChange", callback?: AsyncCallback<number>): void;
      on(type: "scoStateChange", callback: AsyncCallback<number>): void;
      off(type: "scoStateChange", callback?: AsyncCallback<number>): void;
      openVoiceRecognition(device: string): boolean;
      closeVoiceRecognition(device: string): boolean;
    }

    interface HandsFreeUnitProfile extends BaseProfile {
      getScoState(device: string): number;
      connect(device: string): boolean;
      disconnect(device: string): boolean;
      on(type: "connectionStateChange", callback: AsyncCallback<number>): void;
      ...
      on(type: "scoStateChange", callback: AsyncCallback<number>): void;
      off(type: "scoStateChange", callback?: AsyncCallback<number>): void;
      sendDTMF(device: string, digit: number): void;
    }
    ...
    interface PanNetworkProfile extends BaseProfile {
      connect(device: string): boolean;
      disconnect(device: string): boolean;
      on(type: "connectionStateChange", callback: AsyncCallback<number>): void;
      off(type: "connectionStateChange", callback?: AsyncCallback<number>): void;
