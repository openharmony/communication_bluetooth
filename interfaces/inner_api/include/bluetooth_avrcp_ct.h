...
public:
     ...
     * @since 6
     */
    void RegisterObserver(std::shared_ptr<AvrcpController::IObserver> observer);
     ...
     * @since 6
     */
    void UnregisterObserver(std::shared_ptr<AvrcpController::IObserver> observer);
...
#ifdef DTFUZZ_TEST
    friend class BluetoothNoDestructor<AvrcpController>;
#endif
};
}  // namespace Bluetooth
}  // namespace OHOS
