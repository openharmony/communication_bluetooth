...
enum BtErrCode {
    ...
    // Huawei extended inner error codes
    BT_ERR_RESTRICT_STATE = BT_ERR_INNER_BASE - 13,
    BT_ERR_CLOUD_DEVICE_BONDING = BT_ERR_INNER_BASE - 14,
    BT_ERR_DISCOVERY_STATE_ERROR = BT_ERR_INNER_BASE - 15,
};
}  // namespace Bluetooth
}  // namespace OHOS
